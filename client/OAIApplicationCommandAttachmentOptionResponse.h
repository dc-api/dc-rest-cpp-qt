...
#ifndef OAIApplicationCommandAttachmentOptionResponse_H
#define OAIApplicationCommandAttachmentOptionResponse_H
...
class OAIApplicationCommandAttachmentOptionResponse : public OAIObject {
public:
    OAIApplicationCommandAttachmentOptionResponse();
    OAIApplicationCommandAttachmentOptionResponse(QString json);
    ~OAIApplicationCommandAttachmentOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandAttachmentOptionResponse)

#endif // OAIApplicationCommandAttachmentOptionResponse_H
