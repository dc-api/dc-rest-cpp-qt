...
#ifndef OAIPartialDiscordIntegrationResponse_H
#define OAIPartialDiscordIntegrationResponse_H
...
class OAIPartialDiscordIntegrationResponse : public OAIObject {
public:
    OAIPartialDiscordIntegrationResponse();
    OAIPartialDiscordIntegrationResponse(QString json);
    ~OAIPartialDiscordIntegrationResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIPartialDiscordIntegrationResponse)

#endif // OAIPartialDiscordIntegrationResponse_H
