...
#ifndef OAIMentionableSelectComponentForMessageRequest_H
#define OAIMentionableSelectComponentForMessageRequest_H
...
namespace dc_rest {
class OAIMentionableSelectComponentForMessageRequest_default_values_inner;

class OAIMentionableSelectComponentForMessageRequest : public OAIObject {
public:
    OAIMentionableSelectComponentForMessageRequest();
    OAIMentionableSelectComponentForMessageRequest(QString json);
    ~OAIMentionableSelectComponentForMessageRequest() override;
    ...
    QList<OAIMentionableSelectComponentForMessageRequest_default_values_inner> getDefaultValues() const;
    void setDefaultValues(const QList<OAIMentionableSelectComponentForMessageRequest_default_values_inner> &default_values);
...
private:
    ...
    QList<OAIMentionableSelectComponentForMessageRequest_default_values_inner> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIMentionableSelectComponentForMessageRequest)

#endif // OAIMentionableSelectComponentForMessageRequest_H
