...
#ifndef OAIBasicMessageResponse_components_inner_H
#define OAIBasicMessageResponse_components_inner_H
...
class OAIBasicMessageResponse_components_inner : public OAIObject {
public:
    OAIBasicMessageResponse_components_inner();
    OAIBasicMessageResponse_components_inner(QString json);
    ~OAIBasicMessageResponse_components_inner() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIBasicMessageResponse_components_inner)

#endif // OAIBasicMessageResponse_components_inner_H
