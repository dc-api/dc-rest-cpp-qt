...
#ifndef OAICreate_auto_moderation_rule_200_response_H
#define OAICreate_auto_moderation_rule_200_response_H
...
class OAICreate_auto_moderation_rule_200_response : public OAIObject {
public:
    OAICreate_auto_moderation_rule_200_response();
    OAICreate_auto_moderation_rule_200_response(QString json);
    ~OAICreate_auto_moderation_rule_200_response() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreate_auto_moderation_rule_200_response)

#endif // OAICreate_auto_moderation_rule_200_response_H
