...
OAIVoiceScheduledEventResponse::OAIVoiceScheduledEventResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVoiceScheduledEventResponse::OAIVoiceScheduledEventResponse() {
    this->initializeModel();
}

OAIVoiceScheduledEventResponse::~OAIVoiceScheduledEventResponse() {}

void OAIVoiceScheduledEventResponse::initializeModel() {
...
void OAIVoiceScheduledEventResponse::fromJson(QString jsonString) {
...
void OAIVoiceScheduledEventResponse::fromJsonObject(QJsonObject json) {
...
QString OAIVoiceScheduledEventResponse::asJson() const {
...
QJsonObject OAIVoiceScheduledEventResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIVoiceScheduledEventResponse::getId() const {
    return m_id;
}
void OAIVoiceScheduledEventResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVoiceScheduledEventResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIVoiceScheduledEventResponse::getGuildId() const {
    return m_guild_id;
}
void OAIVoiceScheduledEventResponse::setGuildId(const QString &guild_id) {
    m_guild_id = guild_id;
    m_guild_id_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_guild_id_Set() const{
    return m_guild_id_isSet;
}

bool OAIVoiceScheduledEventResponse::is_guild_id_Valid() const{
    return m_guild_id_isValid;
}

QString OAIVoiceScheduledEventResponse::getName() const {
    return m_name;
}
void OAIVoiceScheduledEventResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIVoiceScheduledEventResponse::is_name_Valid() const{
    return m_name_isValid;
}

QDateTime OAIVoiceScheduledEventResponse::getScheduledStartTime() const {
    return m_scheduled_start_time;
}
void OAIVoiceScheduledEventResponse::setScheduledStartTime(const QDateTime &scheduled_start_time) {
    m_scheduled_start_time = scheduled_start_time;
    m_scheduled_start_time_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_scheduled_start_time_Set() const{
    return m_scheduled_start_time_isSet;
}

bool OAIVoiceScheduledEventResponse::is_scheduled_start_time_Valid() const{
    return m_scheduled_start_time_isValid;
}

qint32 OAIVoiceScheduledEventResponse::getStatus() const {
    return m_status;
}
void OAIVoiceScheduledEventResponse::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVoiceScheduledEventResponse::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIVoiceScheduledEventResponse::getEntityType() const {
    return m_entity_type;
}
void OAIVoiceScheduledEventResponse::setEntityType(const qint32 &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIVoiceScheduledEventResponse::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QJsonValue OAIVoiceScheduledEventResponse::getPrivacyLevel() const {
    return m_privacy_level;
}
void OAIVoiceScheduledEventResponse::setPrivacyLevel(const QJsonValue &privacy_level) {
    m_privacy_level = privacy_level;
    m_privacy_level_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_privacy_level_Set() const{
    return m_privacy_level_isSet;
}

bool OAIVoiceScheduledEventResponse::is_privacy_level_Valid() const{
    return m_privacy_level_isValid;
}

QString OAIVoiceScheduledEventResponse::getDescription() const {
    return m_description;
}
void OAIVoiceScheduledEventResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIVoiceScheduledEventResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIVoiceScheduledEventResponse::getChannelId() const {
    return m_channel_id;
}
void OAIVoiceScheduledEventResponse::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIVoiceScheduledEventResponse::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAIVoiceScheduledEventResponse::getCreatorId() const {
    return m_creator_id;
}
void OAIVoiceScheduledEventResponse::setCreatorId(const QString &creator_id) {
    m_creator_id = creator_id;
    m_creator_id_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_creator_id_Set() const{
    return m_creator_id_isSet;
}

bool OAIVoiceScheduledEventResponse::is_creator_id_Valid() const{
    return m_creator_id_isValid;
}

OAIUserResponse OAIVoiceScheduledEventResponse::getCreator() const {
    return m_creator;
}
void OAIVoiceScheduledEventResponse::setCreator(const OAIUserResponse &creator) {
    m_creator = creator;
    m_creator_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_creator_Set() const{
    return m_creator_isSet;
}

bool OAIVoiceScheduledEventResponse::is_creator_Valid() const{
    return m_creator_isValid;
}

QString OAIVoiceScheduledEventResponse::getImage() const {
    return m_image;
}
void OAIVoiceScheduledEventResponse::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_image_Set() const{
    return m_image_isSet;
}

bool OAIVoiceScheduledEventResponse::is_image_Valid() const{
    return m_image_isValid;
}

QDateTime OAIVoiceScheduledEventResponse::getScheduledEndTime() const {
    return m_scheduled_end_time;
}
void OAIVoiceScheduledEventResponse::setScheduledEndTime(const QDateTime &scheduled_end_time) {
    m_scheduled_end_time = scheduled_end_time;
    m_scheduled_end_time_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_scheduled_end_time_Set() const{
    return m_scheduled_end_time_isSet;
}

bool OAIVoiceScheduledEventResponse::is_scheduled_end_time_Valid() const{
    return m_scheduled_end_time_isValid;
}

QString OAIVoiceScheduledEventResponse::getEntityId() const {
    return m_entity_id;
}
void OAIVoiceScheduledEventResponse::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIVoiceScheduledEventResponse::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

qint32 OAIVoiceScheduledEventResponse::getUserCount() const {
    return m_user_count;
}
void OAIVoiceScheduledEventResponse::setUserCount(const qint32 &user_count) {
    m_user_count = user_count;
    m_user_count_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_user_count_Set() const{
    return m_user_count_isSet;
}

bool OAIVoiceScheduledEventResponse::is_user_count_Valid() const{
    return m_user_count_isValid;
}

OAIScheduledEventUserResponse OAIVoiceScheduledEventResponse::getUserRsvp() const {
    return m_user_rsvp;
}
void OAIVoiceScheduledEventResponse::setUserRsvp(const OAIScheduledEventUserResponse &user_rsvp) {
    m_user_rsvp = user_rsvp;
    m_user_rsvp_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_user_rsvp_Set() const{
    return m_user_rsvp_isSet;
}

bool OAIVoiceScheduledEventResponse::is_user_rsvp_Valid() const{
    return m_user_rsvp_isValid;
}

OAIObject OAIVoiceScheduledEventResponse::getEntityMetadata() const {
    return m_entity_metadata;
}
void OAIVoiceScheduledEventResponse::setEntityMetadata(const OAIObject &entity_metadata) {
    m_entity_metadata = entity_metadata;
    m_entity_metadata_isSet = true;
}

bool OAIVoiceScheduledEventResponse::is_entity_metadata_Set() const{
    return m_entity_metadata_isSet;
}

bool OAIVoiceScheduledEventResponse::is_entity_metadata_Valid() const{
    return m_entity_metadata_isValid;
}

bool OAIVoiceScheduledEventResponse::isSet() const {
...
bool OAIVoiceScheduledEventResponse::isValid() const {
