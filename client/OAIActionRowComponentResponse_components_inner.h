...
#ifndef OAIActionRowComponentResponse_components_inner_H
#define OAIActionRowComponentResponse_components_inner_H
...
#include "OAIUserSelectDefaultValueResponse.h"
#include <QList>
#include <QSet>
#include <QString>
...
namespace dc_rest {
class OAIStringSelectOptionResponse;
class OAIComponentEmojiResponse;
class OAIUserSelectDefaultValueResponse;

class OAIActionRowComponentResponse_components_inner : public OAIObject {
public:
    OAIActionRowComponentResponse_components_inner();
    OAIActionRowComponentResponse_components_inner(QString json);
    ~OAIActionRowComponentResponse_components_inner() override;
    ...
    QList<OAIStringSelectOptionResponse> getOptions() const;
    void setOptions(const QList<OAIStringSelectOptionResponse> &options);
    ...
    QList<OAIUserSelectDefaultValueResponse> getDefaultValues() const;
    void setDefaultValues(const QList<OAIUserSelectDefaultValueResponse> &default_values);
...
private:
    ...
    QList<OAIStringSelectOptionResponse> m_options;
    ...
    QList<OAIUserSelectDefaultValueResponse> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIActionRowComponentResponse_components_inner)

#endif // OAIActionRowComponentResponse_components_inner_H
