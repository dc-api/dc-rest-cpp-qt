...
#ifndef OAINewMemberActionResponse_H
#define OAINewMemberActionResponse_H
...
class OAINewMemberActionResponse : public OAIObject {
public:
    OAINewMemberActionResponse();
    OAINewMemberActionResponse(QString json);
    ~OAINewMemberActionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAINewMemberActionResponse)

#endif // OAINewMemberActionResponse_H
