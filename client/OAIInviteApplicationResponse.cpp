...
OAIInviteApplicationResponse::OAIInviteApplicationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteApplicationResponse::OAIInviteApplicationResponse() {
    this->initializeModel();
}

OAIInviteApplicationResponse::~OAIInviteApplicationResponse() {}

void OAIInviteApplicationResponse::initializeModel() {
...
void OAIInviteApplicationResponse::fromJson(QString jsonString) {
...
void OAIInviteApplicationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIInviteApplicationResponse::asJson() const {
...
QJsonObject OAIInviteApplicationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIInviteApplicationResponse::getId() const {
    return m_id;
}
void OAIInviteApplicationResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInviteApplicationResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInviteApplicationResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIInviteApplicationResponse::getName() const {
    return m_name;
}
void OAIInviteApplicationResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInviteApplicationResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInviteApplicationResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIInviteApplicationResponse::getDescription() const {
    return m_description;
}
void OAIInviteApplicationResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIInviteApplicationResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIInviteApplicationResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIInviteApplicationResponse::getVerifyKey() const {
    return m_verify_key;
}
void OAIInviteApplicationResponse::setVerifyKey(const QString &verify_key) {
    m_verify_key = verify_key;
    m_verify_key_isSet = true;
}

bool OAIInviteApplicationResponse::is_verify_key_Set() const{
    return m_verify_key_isSet;
}

bool OAIInviteApplicationResponse::is_verify_key_Valid() const{
    return m_verify_key_isValid;
}

qint32 OAIInviteApplicationResponse::getFlags() const {
    return m_flags;
}
void OAIInviteApplicationResponse::setFlags(const qint32 &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIInviteApplicationResponse::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIInviteApplicationResponse::is_flags_Valid() const{
    return m_flags_isValid;
}

QString OAIInviteApplicationResponse::getIcon() const {
    return m_icon;
}
void OAIInviteApplicationResponse::setIcon(const QString &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAIInviteApplicationResponse::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAIInviteApplicationResponse::is_icon_Valid() const{
    return m_icon_isValid;
}

qint32 OAIInviteApplicationResponse::getType() const {
    return m_type;
}
void OAIInviteApplicationResponse::setType(const qint32 &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIInviteApplicationResponse::is_type_Set() const{
    return m_type_isSet;
}

bool OAIInviteApplicationResponse::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIInviteApplicationResponse::getCoverImage() const {
    return m_cover_image;
}
void OAIInviteApplicationResponse::setCoverImage(const QString &cover_image) {
    m_cover_image = cover_image;
    m_cover_image_isSet = true;
}

bool OAIInviteApplicationResponse::is_cover_image_Set() const{
    return m_cover_image_isSet;
}

bool OAIInviteApplicationResponse::is_cover_image_Valid() const{
    return m_cover_image_isValid;
}

QString OAIInviteApplicationResponse::getPrimarySkuId() const {
    return m_primary_sku_id;
}
void OAIInviteApplicationResponse::setPrimarySkuId(const QString &primary_sku_id) {
    m_primary_sku_id = primary_sku_id;
    m_primary_sku_id_isSet = true;
}

bool OAIInviteApplicationResponse::is_primary_sku_id_Set() const{
    return m_primary_sku_id_isSet;
}

bool OAIInviteApplicationResponse::is_primary_sku_id_Valid() const{
    return m_primary_sku_id_isValid;
}

OAIUserResponse OAIInviteApplicationResponse::getBot() const {
    return m_bot;
}
void OAIInviteApplicationResponse::setBot(const OAIUserResponse &bot) {
    m_bot = bot;
    m_bot_isSet = true;
}

bool OAIInviteApplicationResponse::is_bot_Set() const{
    return m_bot_isSet;
}

bool OAIInviteApplicationResponse::is_bot_Valid() const{
    return m_bot_isValid;
}

QString OAIInviteApplicationResponse::getSlug() const {
    return m_slug;
}
void OAIInviteApplicationResponse::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIInviteApplicationResponse::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIInviteApplicationResponse::is_slug_Valid() const{
    return m_slug_isValid;
}

QString OAIInviteApplicationResponse::getGuildId() const {
    return m_guild_id;
}
void OAIInviteApplicationResponse::setGuildId(const QString &guild_id) {
    m_guild_id = guild_id;
    m_guild_id_isSet = true;
}

bool OAIInviteApplicationResponse::is_guild_id_Set() const{
    return m_guild_id_isSet;
}

bool OAIInviteApplicationResponse::is_guild_id_Valid() const{
    return m_guild_id_isValid;
}

QList<QString> OAIInviteApplicationResponse::getRpcOrigins() const {
    return m_rpc_origins;
}
void OAIInviteApplicationResponse::setRpcOrigins(const QList<QString> &rpc_origins) {
    m_rpc_origins = rpc_origins;
    m_rpc_origins_isSet = true;
}

bool OAIInviteApplicationResponse::is_rpc_origins_Set() const{
    return m_rpc_origins_isSet;
}

bool OAIInviteApplicationResponse::is_rpc_origins_Valid() const{
    return m_rpc_origins_isValid;
}

bool OAIInviteApplicationResponse::isBotPublic() const {
    return m_bot_public;
}
void OAIInviteApplicationResponse::setBotPublic(const bool &bot_public) {
    m_bot_public = bot_public;
    m_bot_public_isSet = true;
}

bool OAIInviteApplicationResponse::is_bot_public_Set() const{
    return m_bot_public_isSet;
}

bool OAIInviteApplicationResponse::is_bot_public_Valid() const{
    return m_bot_public_isValid;
}

bool OAIInviteApplicationResponse::isBotRequireCodeGrant() const {
    return m_bot_require_code_grant;
}
void OAIInviteApplicationResponse::setBotRequireCodeGrant(const bool &bot_require_code_grant) {
    m_bot_require_code_grant = bot_require_code_grant;
    m_bot_require_code_grant_isSet = true;
}

bool OAIInviteApplicationResponse::is_bot_require_code_grant_Set() const{
    return m_bot_require_code_grant_isSet;
}

bool OAIInviteApplicationResponse::is_bot_require_code_grant_Valid() const{
    return m_bot_require_code_grant_isValid;
}

QString OAIInviteApplicationResponse::getTermsOfServiceUrl() const {
    return m_terms_of_service_url;
}
void OAIInviteApplicationResponse::setTermsOfServiceUrl(const QString &terms_of_service_url) {
    m_terms_of_service_url = terms_of_service_url;
    m_terms_of_service_url_isSet = true;
}

bool OAIInviteApplicationResponse::is_terms_of_service_url_Set() const{
    return m_terms_of_service_url_isSet;
}

bool OAIInviteApplicationResponse::is_terms_of_service_url_Valid() const{
    return m_terms_of_service_url_isValid;
}

QString OAIInviteApplicationResponse::getPrivacyPolicyUrl() const {
    return m_privacy_policy_url;
}
void OAIInviteApplicationResponse::setPrivacyPolicyUrl(const QString &privacy_policy_url) {
    m_privacy_policy_url = privacy_policy_url;
    m_privacy_policy_url_isSet = true;
}

bool OAIInviteApplicationResponse::is_privacy_policy_url_Set() const{
    return m_privacy_policy_url_isSet;
}

bool OAIInviteApplicationResponse::is_privacy_policy_url_Valid() const{
    return m_privacy_policy_url_isValid;
}

QString OAIInviteApplicationResponse::getCustomInstallUrl() const {
    return m_custom_install_url;
}
void OAIInviteApplicationResponse::setCustomInstallUrl(const QString &custom_install_url) {
    m_custom_install_url = custom_install_url;
    m_custom_install_url_isSet = true;
}

bool OAIInviteApplicationResponse::is_custom_install_url_Set() const{
    return m_custom_install_url_isSet;
}

bool OAIInviteApplicationResponse::is_custom_install_url_Valid() const{
    return m_custom_install_url_isValid;
}

OAIApplicationOAuth2InstallParamsResponse OAIInviteApplicationResponse::getInstallParams() const {
    return m_install_params;
}
void OAIInviteApplicationResponse::setInstallParams(const OAIApplicationOAuth2InstallParamsResponse &install_params) {
    m_install_params = install_params;
    m_install_params_isSet = true;
}

bool OAIInviteApplicationResponse::is_install_params_Set() const{
    return m_install_params_isSet;
}

bool OAIInviteApplicationResponse::is_install_params_Valid() const{
    return m_install_params_isValid;
}

QMap<QString, OAIApplicationIntegrationTypeConfigurationResponse> OAIInviteApplicationResponse::getIntegrationTypesConfig() const {
    return m_integration_types_config;
}
void OAIInviteApplicationResponse::setIntegrationTypesConfig(const QMap<QString, OAIApplicationIntegrationTypeConfigurationResponse> &integration_types_config) {
    m_integration_types_config = integration_types_config;
    m_integration_types_config_isSet = true;
}

bool OAIInviteApplicationResponse::is_integration_types_config_Set() const{
    return m_integration_types_config_isSet;
}

bool OAIInviteApplicationResponse::is_integration_types_config_Valid() const{
    return m_integration_types_config_isValid;
}

qint32 OAIInviteApplicationResponse::getMaxParticipants() const {
    return m_max_participants;
}
void OAIInviteApplicationResponse::setMaxParticipants(const qint32 &max_participants) {
    m_max_participants = max_participants;
    m_max_participants_isSet = true;
}

bool OAIInviteApplicationResponse::is_max_participants_Set() const{
    return m_max_participants_isSet;
}

bool OAIInviteApplicationResponse::is_max_participants_Valid() const{
    return m_max_participants_isValid;
}

QSet<QString> OAIInviteApplicationResponse::getTags() const {
    return m_tags;
}
void OAIInviteApplicationResponse::setTags(const QSet<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIInviteApplicationResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIInviteApplicationResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIInviteApplicationResponse::isSet() const {
...
bool OAIInviteApplicationResponse::isValid() const {
