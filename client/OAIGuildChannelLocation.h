...
#ifndef OAIGuildChannelLocation_H
#define OAIGuildChannelLocation_H
...
class OAIGuildChannelLocation : public OAIObject {
public:
    OAIGuildChannelLocation();
    OAIGuildChannelLocation(QString json);
    ~OAIGuildChannelLocation() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildChannelLocation)

#endif // OAIGuildChannelLocation_H
