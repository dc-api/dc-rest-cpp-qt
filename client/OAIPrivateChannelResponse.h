...
#ifndef OAIPrivateChannelResponse_H
#define OAIPrivateChannelResponse_H
...
class OAIPrivateChannelResponse : public OAIObject {
public:
    OAIPrivateChannelResponse();
    OAIPrivateChannelResponse(QString json);
    ~OAIPrivateChannelResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIPrivateChannelResponse)

#endif // OAIPrivateChannelResponse_H
