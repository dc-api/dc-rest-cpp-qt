...
#ifndef OAIMLSpamUpsertRequest_H
#define OAIMLSpamUpsertRequest_H
...
class OAIMLSpamUpsertRequest : public OAIObject {
public:
    OAIMLSpamUpsertRequest();
    OAIMLSpamUpsertRequest(QString json);
    ~OAIMLSpamUpsertRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMLSpamUpsertRequest)

#endif // OAIMLSpamUpsertRequest_H
