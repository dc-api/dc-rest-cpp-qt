...
#ifndef OAIApplicationCommandUserOptionResponse_H
#define OAIApplicationCommandUserOptionResponse_H
...
class OAIApplicationCommandUserOptionResponse : public OAIObject {
public:
    OAIApplicationCommandUserOptionResponse();
    OAIApplicationCommandUserOptionResponse(QString json);
    ~OAIApplicationCommandUserOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandUserOptionResponse)

#endif // OAIApplicationCommandUserOptionResponse_H
