...
OAIGuildCreateRequest::OAIGuildCreateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGuildCreateRequest::OAIGuildCreateRequest() {
    this->initializeModel();
}

OAIGuildCreateRequest::~OAIGuildCreateRequest() {}

void OAIGuildCreateRequest::initializeModel() {
...
void OAIGuildCreateRequest::fromJson(QString jsonString) {
...
void OAIGuildCreateRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGuildCreateRequest::asJson() const {
...
QJsonObject OAIGuildCreateRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIGuildCreateRequest::getName() const {
    return m_name;
}
void OAIGuildCreateRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGuildCreateRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGuildCreateRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGuildCreateRequest::getDescription() const {
    return m_description;
}
void OAIGuildCreateRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGuildCreateRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGuildCreateRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGuildCreateRequest::getRegion() const {
    return m_region;
}
void OAIGuildCreateRequest::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIGuildCreateRequest::is_region_Set() const{
    return m_region_isSet;
}

bool OAIGuildCreateRequest::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIGuildCreateRequest::getIcon() const {
    return m_icon;
}
void OAIGuildCreateRequest::setIcon(const QString &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAIGuildCreateRequest::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAIGuildCreateRequest::is_icon_Valid() const{
    return m_icon_isValid;
}

qint32 OAIGuildCreateRequest::getVerificationLevel() const {
    return m_verification_level;
}
void OAIGuildCreateRequest::setVerificationLevel(const qint32 &verification_level) {
    m_verification_level = verification_level;
    m_verification_level_isSet = true;
}

bool OAIGuildCreateRequest::is_verification_level_Set() const{
    return m_verification_level_isSet;
}

bool OAIGuildCreateRequest::is_verification_level_Valid() const{
    return m_verification_level_isValid;
}

qint32 OAIGuildCreateRequest::getDefaultMessageNotifications() const {
    return m_default_message_notifications;
}
void OAIGuildCreateRequest::setDefaultMessageNotifications(const qint32 &default_message_notifications) {
    m_default_message_notifications = default_message_notifications;
    m_default_message_notifications_isSet = true;
}

bool OAIGuildCreateRequest::is_default_message_notifications_Set() const{
    return m_default_message_notifications_isSet;
}

bool OAIGuildCreateRequest::is_default_message_notifications_Valid() const{
    return m_default_message_notifications_isValid;
}

qint32 OAIGuildCreateRequest::getExplicitContentFilter() const {
    return m_explicit_content_filter;
}
void OAIGuildCreateRequest::setExplicitContentFilter(const qint32 &explicit_content_filter) {
    m_explicit_content_filter = explicit_content_filter;
    m_explicit_content_filter_isSet = true;
}

bool OAIGuildCreateRequest::is_explicit_content_filter_Set() const{
    return m_explicit_content_filter_isSet;
}

bool OAIGuildCreateRequest::is_explicit_content_filter_Valid() const{
    return m_explicit_content_filter_isValid;
}

QString OAIGuildCreateRequest::getPreferredLocale() const {
    return m_preferred_locale;
}
void OAIGuildCreateRequest::setPreferredLocale(const QString &preferred_locale) {
    m_preferred_locale = preferred_locale;
    m_preferred_locale_isSet = true;
}

bool OAIGuildCreateRequest::is_preferred_locale_Set() const{
    return m_preferred_locale_isSet;
}

bool OAIGuildCreateRequest::is_preferred_locale_Valid() const{
    return m_preferred_locale_isValid;
}

qint32 OAIGuildCreateRequest::getAfkTimeout() const {
    return m_afk_timeout;
}
void OAIGuildCreateRequest::setAfkTimeout(const qint32 &afk_timeout) {
    m_afk_timeout = afk_timeout;
    m_afk_timeout_isSet = true;
}

bool OAIGuildCreateRequest::is_afk_timeout_Set() const{
    return m_afk_timeout_isSet;
}

bool OAIGuildCreateRequest::is_afk_timeout_Valid() const{
    return m_afk_timeout_isValid;
}

QList<OAICreateGuildRequestRoleItem> OAIGuildCreateRequest::getRoles() const {
    return m_roles;
}
void OAIGuildCreateRequest::setRoles(const QList<OAICreateGuildRequestRoleItem> &roles) {
    m_roles = roles;
    m_roles_isSet = true;
}

bool OAIGuildCreateRequest::is_roles_Set() const{
    return m_roles_isSet;
}

bool OAIGuildCreateRequest::is_roles_Valid() const{
    return m_roles_isValid;
}

QList<OAICreateGuildRequestChannelItem> OAIGuildCreateRequest::getChannels() const {
    return m_channels;
}
void OAIGuildCreateRequest::setChannels(const QList<OAICreateGuildRequestChannelItem> &channels) {
    m_channels = channels;
    m_channels_isSet = true;
}

bool OAIGuildCreateRequest::is_channels_Set() const{
    return m_channels_isSet;
}

bool OAIGuildCreateRequest::is_channels_Valid() const{
    return m_channels_isValid;
}

QString OAIGuildCreateRequest::getAfkChannelId() const {
    return m_afk_channel_id;
}
void OAIGuildCreateRequest::setAfkChannelId(const QString &afk_channel_id) {
    m_afk_channel_id = afk_channel_id;
    m_afk_channel_id_isSet = true;
}

bool OAIGuildCreateRequest::is_afk_channel_id_Set() const{
    return m_afk_channel_id_isSet;
}

bool OAIGuildCreateRequest::is_afk_channel_id_Valid() const{
    return m_afk_channel_id_isValid;
}

QString OAIGuildCreateRequest::getSystemChannelId() const {
    return m_system_channel_id;
}
void OAIGuildCreateRequest::setSystemChannelId(const QString &system_channel_id) {
    m_system_channel_id = system_channel_id;
    m_system_channel_id_isSet = true;
}

bool OAIGuildCreateRequest::is_system_channel_id_Set() const{
    return m_system_channel_id_isSet;
}

bool OAIGuildCreateRequest::is_system_channel_id_Valid() const{
    return m_system_channel_id_isValid;
}

qint32 OAIGuildCreateRequest::getSystemChannelFlags() const {
    return m_system_channel_flags;
}
void OAIGuildCreateRequest::setSystemChannelFlags(const qint32 &system_channel_flags) {
    m_system_channel_flags = system_channel_flags;
    m_system_channel_flags_isSet = true;
}

bool OAIGuildCreateRequest::is_system_channel_flags_Set() const{
    return m_system_channel_flags_isSet;
}

bool OAIGuildCreateRequest::is_system_channel_flags_Valid() const{
    return m_system_channel_flags_isValid;
}

bool OAIGuildCreateRequest::isSet() const {
...
bool OAIGuildCreateRequest::isValid() const {
