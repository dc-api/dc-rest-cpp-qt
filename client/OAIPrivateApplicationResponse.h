...
#ifndef OAIPrivateApplicationResponse_H
#define OAIPrivateApplicationResponse_H
...
class OAIPrivateApplicationResponse : public OAIObject {
public:
    OAIPrivateApplicationResponse();
    OAIPrivateApplicationResponse(QString json);
    ~OAIPrivateApplicationResponse() override;
    ...
    OAIUserResponse getOwner() const;
    void setOwner(const OAIUserResponse &owner);
    bool is_owner_Set() const;
    bool is_owner_Valid() const;

    qint32 getApproximateUserInstallCount() const;
    void setApproximateUserInstallCount(const qint32 &approximate_user_install_count);
    bool is_approximate_user_install_count_Set() const;
    bool is_approximate_user_install_count_Valid() const;

    qint32 getApproximateUserAuthorizationCount() const;
    void setApproximateUserAuthorizationCount(const qint32 &approximate_user_authorization_count);
    bool is_approximate_user_authorization_count_Set() const;
    bool is_approximate_user_authorization_count_Valid() const;
    ...
    qint32 getApproximateGuildCount() const;
    void setApproximateGuildCount(const qint32 &approximate_guild_count);
    bool is_approximate_guild_count_Set() const;
    bool is_approximate_guild_count_Valid() const;

    OAITeamResponse getTeam() const;
    void setTeam(const OAITeamResponse &team);
...
private:
    ...
    OAIUserResponse m_owner;
    bool m_owner_isSet;
    bool m_owner_isValid;

    qint32 m_approximate_user_install_count;
    bool m_approximate_user_install_count_isSet;
    bool m_approximate_user_install_count_isValid;

    qint32 m_approximate_user_authorization_count;
    bool m_approximate_user_authorization_count_isSet;
    bool m_approximate_user_authorization_count_isValid;
    ...
    qint32 m_approximate_guild_count;
    bool m_approximate_guild_count_isSet;
    bool m_approximate_guild_count_isValid;

    OAITeamResponse m_team;
    bool m_team_isSet;
    bool m_team_isValid;
};
...
Q_DECLARE_METATYPE(dc_rest::OAIPrivateApplicationResponse)

#endif // OAIPrivateApplicationResponse_H
