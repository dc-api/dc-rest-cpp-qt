...
class OAIMessageReactionResponse;
class OAIBasicMessageResponse;
...
public:
    ...
    QList<OAIMessageReactionResponse> getReactions() const;
    void setReactions(const QList<OAIMessageReactionResponse> &reactions);
    bool is_reactions_Set() const;
    bool is_reactions_Valid() const;

    OAIBasicMessageResponse getReferencedMessage() const;
    void setReferencedMessage(const OAIBasicMessageResponse &referenced_message);
    bool is_referenced_message_Set() const;
    bool is_referenced_message_Valid() const;
...
private:
    ...
    QList<OAIMessageReactionResponse> m_reactions;
    bool m_reactions_isSet;
    bool m_reactions_isValid;

    OAIBasicMessageResponse m_referenced_message;
    bool m_referenced_message_isSet;
    bool m_referenced_message_isValid;
};

} // namespace dc_rest

Q_DECLARE_METATYPE(dc_rest::OAIMessageResponse)
