...
#ifndef OAIApplicationCommandSubcommandGroupOptionResponse_H
#define OAIApplicationCommandSubcommandGroupOptionResponse_H
...
namespace dc_rest {
class OAIApplicationCommandSubcommandOptionResponse;

class OAIApplicationCommandSubcommandGroupOptionResponse : public OAIObject {
public:
    OAIApplicationCommandSubcommandGroupOptionResponse();
    OAIApplicationCommandSubcommandGroupOptionResponse(QString json);
    ~OAIApplicationCommandSubcommandGroupOptionResponse() override;
    ...
    QList<OAIApplicationCommandSubcommandOptionResponse> getOptions() const;
    void setOptions(const QList<OAIApplicationCommandSubcommandOptionResponse> &options);
...
private:
    ...
    QList<OAIApplicationCommandSubcommandOptionResponse> m_options;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandSubcommandGroupOptionResponse)

#endif // OAIApplicationCommandSubcommandGroupOptionResponse_H
