...
#ifndef OAITextInputComponentResponse_H
#define OAITextInputComponentResponse_H
...
class OAITextInputComponentResponse : public OAIObject {
public:
    OAITextInputComponentResponse();
    OAITextInputComponentResponse(QString json);
    ~OAITextInputComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAITextInputComponentResponse)

#endif // OAITextInputComponentResponse_H
