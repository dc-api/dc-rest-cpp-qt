...
#ifndef OAIRichEmbedThumbnail_H
#define OAIRichEmbedThumbnail_H
...
class OAIRichEmbedThumbnail : public OAIObject {
public:
    OAIRichEmbedThumbnail();
    OAIRichEmbedThumbnail(QString json);
    ~OAIRichEmbedThumbnail() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIRichEmbedThumbnail)

#endif // OAIRichEmbedThumbnail_H
