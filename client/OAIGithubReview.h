...
#ifndef OAIGithubReview_H
#define OAIGithubReview_H
...
class OAIGithubReview : public OAIObject {
public:
    OAIGithubReview();
    OAIGithubReview(QString json);
    ~OAIGithubReview() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGithubReview)

#endif // OAIGithubReview_H
