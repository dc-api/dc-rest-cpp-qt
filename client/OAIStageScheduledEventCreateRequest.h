...
#ifndef OAIStageScheduledEventCreateRequest_H
#define OAIStageScheduledEventCreateRequest_H
...
class OAIStageScheduledEventCreateRequest : public OAIObject {
public:
    OAIStageScheduledEventCreateRequest();
    OAIStageScheduledEventCreateRequest(QString json);
    ~OAIStageScheduledEventCreateRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStageScheduledEventCreateRequest)

#endif // OAIStageScheduledEventCreateRequest_H
