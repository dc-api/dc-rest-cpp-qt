...
#ifndef OAIAdd_group_dm_user_201_response_H
#define OAIAdd_group_dm_user_201_response_H
...
class OAIAdd_group_dm_user_201_response : public OAIObject {
public:
    OAIAdd_group_dm_user_201_response();
    OAIAdd_group_dm_user_201_response(QString json);
    ~OAIAdd_group_dm_user_201_response() override;
    ...
    QList<OAIUserResponse> getRecipients() const;
    void setRecipients(const QList<OAIUserResponse> &recipients);
...
private:
    ...
    QList<OAIUserResponse> m_recipients;
...
Q_DECLARE_METATYPE(dc_rest::OAIAdd_group_dm_user_201_response)

#endif // OAIAdd_group_dm_user_201_response_H
