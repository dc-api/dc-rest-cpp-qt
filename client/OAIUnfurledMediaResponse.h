...
#ifndef OAIUnfurledMediaResponse_H
#define OAIUnfurledMediaResponse_H
...
class OAIUnfurledMediaResponse : public OAIObject {
public:
    OAIUnfurledMediaResponse();
    OAIUnfurledMediaResponse(QString json);
    ~OAIUnfurledMediaResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUnfurledMediaResponse)

#endif // OAIUnfurledMediaResponse_H
