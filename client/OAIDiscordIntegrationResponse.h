...
#ifndef OAIDiscordIntegrationResponse_H
#define OAIDiscordIntegrationResponse_H
...
class OAIDiscordIntegrationResponse : public OAIObject {
public:
    OAIDiscordIntegrationResponse();
    OAIDiscordIntegrationResponse(QString json);
    ~OAIDiscordIntegrationResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIDiscordIntegrationResponse)

#endif // OAIDiscordIntegrationResponse_H
