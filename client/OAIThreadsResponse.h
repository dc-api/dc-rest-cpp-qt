...
#ifndef OAIThreadsResponse_H
#define OAIThreadsResponse_H
...
class OAIThreadsResponse : public OAIObject {
public:
    OAIThreadsResponse();
    OAIThreadsResponse(QString json);
    ~OAIThreadsResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIThreadsResponse)

#endif // OAIThreadsResponse_H
