...
#ifndef OAISoundboardSoundResponse_H
#define OAISoundboardSoundResponse_H
...
class OAISoundboardSoundResponse : public OAIObject {
public:
    OAISoundboardSoundResponse();
    OAISoundboardSoundResponse(QString json);
    ~OAISoundboardSoundResponse() override;
    ...
    void setSoundId(const QString &sound_id);
    bool is_sound_id_Set() const;
    bool is_sound_id_Valid() const;
...
private:
    ...
    QString m_sound_id;
    bool m_sound_id_isSet;
    bool m_sound_id_isValid;
...
Q_DECLARE_METATYPE(dc_rest::OAISoundboardSoundResponse)

#endif // OAISoundboardSoundResponse_H
