...
#ifndef OAIDefaultKeywordListUpsertRequestPartial_H
#define OAIDefaultKeywordListUpsertRequestPartial_H
...
class OAIDefaultKeywordListTriggerMetadata;

class OAIDefaultKeywordListUpsertRequestPartial : public OAIObject {
public:
    OAIDefaultKeywordListUpsertRequestPartial();
    OAIDefaultKeywordListUpsertRequestPartial(QString json);
    ~OAIDefaultKeywordListUpsertRequestPartial() override;
    ...
    OAIDefaultKeywordListTriggerMetadata getTriggerMetadata() const;
    void setTriggerMetadata(const OAIDefaultKeywordListTriggerMetadata &trigger_metadata);
...
private:
    ...
    OAIDefaultKeywordListTriggerMetadata m_trigger_metadata;
...
Q_DECLARE_METATYPE(dc_rest::OAIDefaultKeywordListUpsertRequestPartial)

#endif // OAIDefaultKeywordListUpsertRequestPartial_H
