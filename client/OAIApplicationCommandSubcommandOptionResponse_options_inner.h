...
#ifndef OAIApplicationCommandSubcommandOptionResponse_options_inner_H
#define OAIApplicationCommandSubcommandOptionResponse_options_inner_H
...
class OAIApplicationCommandSubcommandOptionResponse_options_inner : public OAIObject {
public:
    OAIApplicationCommandSubcommandOptionResponse_options_inner();
    OAIApplicationCommandSubcommandOptionResponse_options_inner(QString json);
    ~OAIApplicationCommandSubcommandOptionResponse_options_inner() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandSubcommandOptionResponse_options_inner)

#endif // OAIApplicationCommandSubcommandOptionResponse_options_inner_H
