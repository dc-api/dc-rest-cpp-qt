...
#ifndef OAIExternalScheduledEventResponse_H
#define OAIExternalScheduledEventResponse_H
...
namespace dc_rest {
class OAIEntityMetadataExternalResponse;
class OAIUserResponse;
class OAIScheduledEventUserResponse;

class OAIExternalScheduledEventResponse : public OAIObject {
public:
    OAIExternalScheduledEventResponse();
    OAIExternalScheduledEventResponse(QString json);
    ~OAIExternalScheduledEventResponse() override;
    ...
    OAIEntityMetadataExternalResponse getEntityMetadata() const;
    void setEntityMetadata(const OAIEntityMetadataExternalResponse &entity_metadata);
...
private:
    ...
    OAIEntityMetadataExternalResponse m_entity_metadata;
...
Q_DECLARE_METATYPE(dc_rest::OAIExternalScheduledEventResponse)

#endif // OAIExternalScheduledEventResponse_H
