...
#ifndef OAIKeywordRuleResponse_H
#define OAIKeywordRuleResponse_H
...
class OAIKeywordTriggerMetadataResponse;

class OAIKeywordRuleResponse : public OAIObject {
public:
    OAIKeywordRuleResponse();
    OAIKeywordRuleResponse(QString json);
    ~OAIKeywordRuleResponse() override;
    ...
    OAIKeywordTriggerMetadataResponse getTriggerMetadata() const;
    void setTriggerMetadata(const OAIKeywordTriggerMetadataResponse &trigger_metadata);
...
private:
    ...
    OAIKeywordTriggerMetadataResponse m_trigger_metadata;
...
Q_DECLARE_METATYPE(dc_rest::OAIKeywordRuleResponse)

#endif // OAIKeywordRuleResponse_H
