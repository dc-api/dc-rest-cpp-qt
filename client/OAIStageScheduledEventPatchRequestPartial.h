...
#ifndef OAIStageScheduledEventPatchRequestPartial_H
#define OAIStageScheduledEventPatchRequestPartial_H
...
class OAIStageScheduledEventPatchRequestPartial : public OAIObject {
public:
    OAIStageScheduledEventPatchRequestPartial();
    OAIStageScheduledEventPatchRequestPartial(QString json);
    ~OAIStageScheduledEventPatchRequestPartial() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStageScheduledEventPatchRequestPartial)

#endif // OAIStageScheduledEventPatchRequestPartial_H
