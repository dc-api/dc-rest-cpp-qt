...
#ifndef OAIApplicationCommandIntegerOption_H
#define OAIApplicationCommandIntegerOption_H
...
class OAIApplicationCommandIntegerOption : public OAIObject {
public:
    OAIApplicationCommandIntegerOption();
    OAIApplicationCommandIntegerOption(QString json);
    ~OAIApplicationCommandIntegerOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandIntegerOption)

#endif // OAIApplicationCommandIntegerOption_H
