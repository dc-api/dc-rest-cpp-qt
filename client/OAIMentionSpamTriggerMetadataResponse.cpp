...
OAIMentionSpamTriggerMetadataResponse::OAIMentionSpamTriggerMetadataResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMentionSpamTriggerMetadataResponse::OAIMentionSpamTriggerMetadataResponse() {
    this->initializeModel();
}

OAIMentionSpamTriggerMetadataResponse::~OAIMentionSpamTriggerMetadataResponse() {}

void OAIMentionSpamTriggerMetadataResponse::initializeModel() {
...
void OAIMentionSpamTriggerMetadataResponse::fromJson(QString jsonString) {
...
void OAIMentionSpamTriggerMetadataResponse::fromJsonObject(QJsonObject json) {
...
QString OAIMentionSpamTriggerMetadataResponse::asJson() const {
...
QJsonObject OAIMentionSpamTriggerMetadataResponse::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMentionSpamTriggerMetadataResponse::getMentionTotalLimit() const {
    return m_mention_total_limit;
}
void OAIMentionSpamTriggerMetadataResponse::setMentionTotalLimit(const qint32 &mention_total_limit) {
    m_mention_total_limit = mention_total_limit;
    m_mention_total_limit_isSet = true;
}

bool OAIMentionSpamTriggerMetadataResponse::is_mention_total_limit_Set() const{
    return m_mention_total_limit_isSet;
}

bool OAIMentionSpamTriggerMetadataResponse::is_mention_total_limit_Valid() const{
    return m_mention_total_limit_isValid;
}

bool OAIMentionSpamTriggerMetadataResponse::isMentionRaidProtectionEnabled() const {
    return m_mention_raid_protection_enabled;
}
void OAIMentionSpamTriggerMetadataResponse::setMentionRaidProtectionEnabled(const bool &mention_raid_protection_enabled) {
    m_mention_raid_protection_enabled = mention_raid_protection_enabled;
    m_mention_raid_protection_enabled_isSet = true;
}

bool OAIMentionSpamTriggerMetadataResponse::is_mention_raid_protection_enabled_Set() const{
    return m_mention_raid_protection_enabled_isSet;
}

bool OAIMentionSpamTriggerMetadataResponse::is_mention_raid_protection_enabled_Valid() const{
    return m_mention_raid_protection_enabled_isValid;
}

bool OAIMentionSpamTriggerMetadataResponse::isSet() const {
...
bool OAIMentionSpamTriggerMetadataResponse::isValid() const {
