...
#ifndef OAIEmbeddedActivityInstance_H
#define OAIEmbeddedActivityInstance_H
...
namespace dc_rest {
class OAIEmbeddedActivityInstance_location;

class OAIEmbeddedActivityInstance : public OAIObject {
public:
    OAIEmbeddedActivityInstance();
    OAIEmbeddedActivityInstance(QString json);
    ~OAIEmbeddedActivityInstance() override;
    ...
    bool is_launch_id_Set() const;
    bool is_launch_id_Valid() const;
    ...
    OAIEmbeddedActivityInstance_location getLocation() const;
    void setLocation(const OAIEmbeddedActivityInstance_location &location);
...
private:
    ...
    QString m_launch_id;
    bool m_launch_id_isSet;
    bool m_launch_id_isValid;

    QList<QString> m_users;
    bool m_users_isSet;
    bool m_users_isValid;

    OAIEmbeddedActivityInstance_location m_location;
...
Q_DECLARE_METATYPE(dc_rest::OAIEmbeddedActivityInstance)

#endif // OAIEmbeddedActivityInstance_H
