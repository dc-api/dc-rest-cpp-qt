...
#ifndef OAIApplicationCommandCreateRequest_H
#define OAIApplicationCommandCreateRequest_H
...
class OAIApplicationCommandCreateRequest : public OAIObject {
public:
    OAIApplicationCommandCreateRequest();
    OAIApplicationCommandCreateRequest(QString json);
    ~OAIApplicationCommandCreateRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandCreateRequest)

#endif // OAIApplicationCommandCreateRequest_H
