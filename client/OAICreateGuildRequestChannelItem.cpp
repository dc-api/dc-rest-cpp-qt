...
#include "OAICreateGuildRequestChannelItem.h"
...
OAICreateGuildRequestChannelItem::OAICreateGuildRequestChannelItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGuildRequestChannelItem::OAICreateGuildRequestChannelItem() {
    this->initializeModel();
}

OAICreateGuildRequestChannelItem::~OAICreateGuildRequestChannelItem() {}

void OAICreateGuildRequestChannelItem::initializeModel() {
...
void OAICreateGuildRequestChannelItem::fromJson(QString jsonString) {
...
void OAICreateGuildRequestChannelItem::fromJsonObject(QJsonObject json) {
...
QString OAICreateGuildRequestChannelItem::asJson() const {
...
QJsonObject OAICreateGuildRequestChannelItem::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateGuildRequestChannelItem::getName() const {
    return m_name;
}
void OAICreateGuildRequestChannelItem::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateGuildRequestChannelItem::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getType() const {
    return m_type;
}
void OAICreateGuildRequestChannelItem::setType(const qint32 &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateGuildRequestChannelItem::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getPosition() const {
    return m_position;
}
void OAICreateGuildRequestChannelItem::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_position_Set() const{
    return m_position_isSet;
}

bool OAICreateGuildRequestChannelItem::is_position_Valid() const{
    return m_position_isValid;
}

QString OAICreateGuildRequestChannelItem::getTopic() const {
    return m_topic;
}
void OAICreateGuildRequestChannelItem::setTopic(const QString &topic) {
    m_topic = topic;
    m_topic_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_topic_Set() const{
    return m_topic_isSet;
}

bool OAICreateGuildRequestChannelItem::is_topic_Valid() const{
    return m_topic_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getBitrate() const {
    return m_bitrate;
}
void OAICreateGuildRequestChannelItem::setBitrate(const qint32 &bitrate) {
    m_bitrate = bitrate;
    m_bitrate_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_bitrate_Set() const{
    return m_bitrate_isSet;
}

bool OAICreateGuildRequestChannelItem::is_bitrate_Valid() const{
    return m_bitrate_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getUserLimit() const {
    return m_user_limit;
}
void OAICreateGuildRequestChannelItem::setUserLimit(const qint32 &user_limit) {
    m_user_limit = user_limit;
    m_user_limit_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_user_limit_Set() const{
    return m_user_limit_isSet;
}

bool OAICreateGuildRequestChannelItem::is_user_limit_Valid() const{
    return m_user_limit_isValid;
}

bool OAICreateGuildRequestChannelItem::isNsfw() const {
    return m_nsfw;
}
void OAICreateGuildRequestChannelItem::setNsfw(const bool &nsfw) {
    m_nsfw = nsfw;
    m_nsfw_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_nsfw_Set() const{
    return m_nsfw_isSet;
}

bool OAICreateGuildRequestChannelItem::is_nsfw_Valid() const{
    return m_nsfw_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getRateLimitPerUser() const {
    return m_rate_limit_per_user;
}
void OAICreateGuildRequestChannelItem::setRateLimitPerUser(const qint32 &rate_limit_per_user) {
    m_rate_limit_per_user = rate_limit_per_user;
    m_rate_limit_per_user_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_rate_limit_per_user_Set() const{
    return m_rate_limit_per_user_isSet;
}

bool OAICreateGuildRequestChannelItem::is_rate_limit_per_user_Valid() const{
    return m_rate_limit_per_user_isValid;
}

QString OAICreateGuildRequestChannelItem::getParentId() const {
    return m_parent_id;
}
void OAICreateGuildRequestChannelItem::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAICreateGuildRequestChannelItem::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QList<OAIChannelPermissionOverwriteRequest> OAICreateGuildRequestChannelItem::getPermissionOverwrites() const {
    return m_permission_overwrites;
}
void OAICreateGuildRequestChannelItem::setPermissionOverwrites(const QList<OAIChannelPermissionOverwriteRequest> &permission_overwrites) {
    m_permission_overwrites = permission_overwrites;
    m_permission_overwrites_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_permission_overwrites_Set() const{
    return m_permission_overwrites_isSet;
}

bool OAICreateGuildRequestChannelItem::is_permission_overwrites_Valid() const{
    return m_permission_overwrites_isValid;
}

QString OAICreateGuildRequestChannelItem::getRtcRegion() const {
    return m_rtc_region;
}
void OAICreateGuildRequestChannelItem::setRtcRegion(const QString &rtc_region) {
    m_rtc_region = rtc_region;
    m_rtc_region_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_rtc_region_Set() const{
    return m_rtc_region_isSet;
}

bool OAICreateGuildRequestChannelItem::is_rtc_region_Valid() const{
    return m_rtc_region_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getVideoQualityMode() const {
    return m_video_quality_mode;
}
void OAICreateGuildRequestChannelItem::setVideoQualityMode(const qint32 &video_quality_mode) {
    m_video_quality_mode = video_quality_mode;
    m_video_quality_mode_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_video_quality_mode_Set() const{
    return m_video_quality_mode_isSet;
}

bool OAICreateGuildRequestChannelItem::is_video_quality_mode_Valid() const{
    return m_video_quality_mode_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getDefaultAutoArchiveDuration() const {
    return m_default_auto_archive_duration;
}
void OAICreateGuildRequestChannelItem::setDefaultAutoArchiveDuration(const qint32 &default_auto_archive_duration) {
    m_default_auto_archive_duration = default_auto_archive_duration;
    m_default_auto_archive_duration_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_default_auto_archive_duration_Set() const{
    return m_default_auto_archive_duration_isSet;
}

bool OAICreateGuildRequestChannelItem::is_default_auto_archive_duration_Valid() const{
    return m_default_auto_archive_duration_isValid;
}

OAIUpdateDefaultReactionEmojiRequest OAICreateGuildRequestChannelItem::getDefaultReactionEmoji() const {
    return m_default_reaction_emoji;
}
void OAICreateGuildRequestChannelItem::setDefaultReactionEmoji(const OAIUpdateDefaultReactionEmojiRequest &default_reaction_emoji) {
    m_default_reaction_emoji = default_reaction_emoji;
    m_default_reaction_emoji_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_default_reaction_emoji_Set() const{
    return m_default_reaction_emoji_isSet;
}

bool OAICreateGuildRequestChannelItem::is_default_reaction_emoji_Valid() const{
    return m_default_reaction_emoji_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getDefaultThreadRateLimitPerUser() const {
    return m_default_thread_rate_limit_per_user;
}
void OAICreateGuildRequestChannelItem::setDefaultThreadRateLimitPerUser(const qint32 &default_thread_rate_limit_per_user) {
    m_default_thread_rate_limit_per_user = default_thread_rate_limit_per_user;
    m_default_thread_rate_limit_per_user_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_default_thread_rate_limit_per_user_Set() const{
    return m_default_thread_rate_limit_per_user_isSet;
}

bool OAICreateGuildRequestChannelItem::is_default_thread_rate_limit_per_user_Valid() const{
    return m_default_thread_rate_limit_per_user_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getDefaultSortOrder() const {
    return m_default_sort_order;
}
void OAICreateGuildRequestChannelItem::setDefaultSortOrder(const qint32 &default_sort_order) {
    m_default_sort_order = default_sort_order;
    m_default_sort_order_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_default_sort_order_Set() const{
    return m_default_sort_order_isSet;
}

bool OAICreateGuildRequestChannelItem::is_default_sort_order_Valid() const{
    return m_default_sort_order_isValid;
}

qint32 OAICreateGuildRequestChannelItem::getDefaultForumLayout() const {
    return m_default_forum_layout;
}
void OAICreateGuildRequestChannelItem::setDefaultForumLayout(const qint32 &default_forum_layout) {
    m_default_forum_layout = default_forum_layout;
    m_default_forum_layout_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_default_forum_layout_Set() const{
    return m_default_forum_layout_isSet;
}

bool OAICreateGuildRequestChannelItem::is_default_forum_layout_Valid() const{
    return m_default_forum_layout_isValid;
}

QString OAICreateGuildRequestChannelItem::getDefaultTagSetting() const {
    return m_default_tag_setting;
}
void OAICreateGuildRequestChannelItem::setDefaultTagSetting(const QString &default_tag_setting) {
    m_default_tag_setting = default_tag_setting;
    m_default_tag_setting_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_default_tag_setting_Set() const{
    return m_default_tag_setting_isSet;
}

bool OAICreateGuildRequestChannelItem::is_default_tag_setting_Valid() const{
    return m_default_tag_setting_isValid;
}

QString OAICreateGuildRequestChannelItem::getId() const {
    return m_id;
}
void OAICreateGuildRequestChannelItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateGuildRequestChannelItem::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAICreateOrUpdateThreadTagRequest> OAICreateGuildRequestChannelItem::getAvailableTags() const {
    return m_available_tags;
}
void OAICreateGuildRequestChannelItem::setAvailableTags(const QList<OAICreateOrUpdateThreadTagRequest> &available_tags) {
    m_available_tags = available_tags;
    m_available_tags_isSet = true;
}

bool OAICreateGuildRequestChannelItem::is_available_tags_Set() const{
    return m_available_tags_isSet;
}

bool OAICreateGuildRequestChannelItem::is_available_tags_Valid() const{
    return m_available_tags_isValid;
}

bool OAICreateGuildRequestChannelItem::isSet() const {
...
bool OAICreateGuildRequestChannelItem::isValid() const {
