...
#ifndef OAIGithubUser_H
#define OAIGithubUser_H
...
class OAIGithubUser : public OAIObject {
public:
    OAIGithubUser();
    OAIGithubUser(QString json);
    ~OAIGithubUser() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGithubUser)

#endif // OAIGithubUser_H
