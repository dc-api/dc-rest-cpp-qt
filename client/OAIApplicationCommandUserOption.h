...
#ifndef OAIApplicationCommandUserOption_H
#define OAIApplicationCommandUserOption_H
...
class OAIApplicationCommandUserOption : public OAIObject {
public:
    OAIApplicationCommandUserOption();
    OAIApplicationCommandUserOption(QString json);
    ~OAIApplicationCommandUserOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandUserOption)

#endif // OAIApplicationCommandUserOption_H
