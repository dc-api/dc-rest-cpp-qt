...
#ifndef OAIUserSelectComponentResponse_H
#define OAIUserSelectComponentResponse_H
...
class OAIUserSelectComponentResponse : public OAIObject {
public:
    OAIUserSelectComponentResponse();
    OAIUserSelectComponentResponse(QString json);
    ~OAIUserSelectComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUserSelectComponentResponse)

#endif // OAIUserSelectComponentResponse_H
