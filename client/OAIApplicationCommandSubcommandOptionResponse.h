...
#ifndef OAIApplicationCommandSubcommandOptionResponse_H
#define OAIApplicationCommandSubcommandOptionResponse_H
...
class OAIApplicationCommandSubcommandOptionResponse : public OAIObject {
public:
    OAIApplicationCommandSubcommandOptionResponse();
    OAIApplicationCommandSubcommandOptionResponse(QString json);
    ~OAIApplicationCommandSubcommandOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandSubcommandOptionResponse)

#endif // OAIApplicationCommandSubcommandOptionResponse_H
