...
#ifndef OAIMessageEmbedImageResponse_H
#define OAIMessageEmbedImageResponse_H
...
class OAIMessageEmbedImageResponse : public OAIObject {
public:
    OAIMessageEmbedImageResponse();
    OAIMessageEmbedImageResponse(QString json);
    ~OAIMessageEmbedImageResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageEmbedImageResponse)

#endif // OAIMessageEmbedImageResponse_H
