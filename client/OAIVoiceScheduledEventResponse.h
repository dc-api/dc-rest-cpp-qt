...
#ifndef OAIVoiceScheduledEventResponse_H
#define OAIVoiceScheduledEventResponse_H
...
class OAIVoiceScheduledEventResponse : public OAIObject {
public:
    OAIVoiceScheduledEventResponse();
    OAIVoiceScheduledEventResponse(QString json);
    ~OAIVoiceScheduledEventResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIVoiceScheduledEventResponse)

#endif // OAIVoiceScheduledEventResponse_H
