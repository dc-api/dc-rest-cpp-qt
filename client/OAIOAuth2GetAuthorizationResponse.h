...
#ifndef OAIOAuth2GetAuthorizationResponse_H
#define OAIOAuth2GetAuthorizationResponse_H
...
class OAIOAuth2GetAuthorizationResponse : public OAIObject {
public:
    OAIOAuth2GetAuthorizationResponse();
    OAIOAuth2GetAuthorizationResponse(QString json);
    ~OAIOAuth2GetAuthorizationResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIOAuth2GetAuthorizationResponse)

#endif // OAIOAuth2GetAuthorizationResponse_H
