...
#ifndef OAIButtonComponentResponse_H
#define OAIButtonComponentResponse_H
...
class OAIButtonComponentResponse : public OAIObject {
public:
    OAIButtonComponentResponse();
    OAIButtonComponentResponse(QString json);
    ~OAIButtonComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIButtonComponentResponse)

#endif // OAIButtonComponentResponse_H
