...
#ifndef OAILobbyMessageResponse_H
#define OAILobbyMessageResponse_H
...
class OAILobbyMessageResponse : public OAIObject {
public:
    OAILobbyMessageResponse();
    OAILobbyMessageResponse(QString json);
    ~OAILobbyMessageResponse() override;
    ...
    void setLobbyId(const QString &lobby_id);
    bool is_lobby_id_Set() const;
    bool is_lobby_id_Valid() const;
...
private:
    ...
    QString m_lobby_id;
    bool m_lobby_id_isSet;
    bool m_lobby_id_isValid;
...
Q_DECLARE_METATYPE(dc_rest::OAILobbyMessageResponse)

#endif // OAILobbyMessageResponse_H
