...
#ifndef OAIGuildStickerResponse_H
#define OAIGuildStickerResponse_H
...
class OAIGuildStickerResponse : public OAIObject {
public:
    OAIGuildStickerResponse();
    OAIGuildStickerResponse(QString json);
    ~OAIGuildStickerResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildStickerResponse)

#endif // OAIGuildStickerResponse_H
