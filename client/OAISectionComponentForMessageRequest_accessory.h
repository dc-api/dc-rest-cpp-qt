...
#ifndef OAISectionComponentForMessageRequest_accessory_H
#define OAISectionComponentForMessageRequest_accessory_H
...
namespace dc_rest {
class OAIUnfurledMediaRequest;
class OAIComponentEmojiForMessageRequest;

class OAISectionComponentForMessageRequest_accessory : public OAIObject {
public:
    OAISectionComponentForMessageRequest_accessory();
    OAISectionComponentForMessageRequest_accessory(QString json);
    ~OAISectionComponentForMessageRequest_accessory() override;
    ...
    OAIUnfurledMediaRequest getMedia() const;
    void setMedia(const OAIUnfurledMediaRequest &media);
...
private:
    ...
    OAIUnfurledMediaRequest m_media;
    bool m_media_isSet;
...
Q_DECLARE_METATYPE(dc_rest::OAISectionComponentForMessageRequest_accessory)

#endif // OAISectionComponentForMessageRequest_accessory_H
