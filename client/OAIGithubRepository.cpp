...
void OAIGithubRepository::fromJsonObject(QJsonObject json) {
    ...
    m_full_name_isValid = ::dc_rest::fromJsonValue(m_full_name, json[QString("full_name")]);
...
QJsonObject OAIGithubRepository::asJsonObject() const {
    ...
    if (m_full_name_isSet) {
        obj.insert(QString("full_name"), ::dc_rest::toJsonValue(m_full_name));
    }
    return obj;
}

qint32 OAIGithubRepository::getId() const {
    return m_id;
}
void OAIGithubRepository::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGithubRepository::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGithubRepository::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGithubRepository::getHtmlUrl() const {
    return m_html_url;
}
void OAIGithubRepository::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAIGithubRepository::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAIGithubRepository::is_html_url_Valid() const{
...
bool OAIGithubRepository::isValid() const {
    ...
    return m_id_isValid && m_html_url_isValid && m_name_isValid && m_full_name_isValid && true;
}
