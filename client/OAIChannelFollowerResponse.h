...
#ifndef OAIChannelFollowerResponse_H
#define OAIChannelFollowerResponse_H
...
class OAIChannelFollowerResponse : public OAIObject {
public:
    OAIChannelFollowerResponse();
    OAIChannelFollowerResponse(QString json);
    ~OAIChannelFollowerResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIChannelFollowerResponse)

#endif // OAIChannelFollowerResponse_H
