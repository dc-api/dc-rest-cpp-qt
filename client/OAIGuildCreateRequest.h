...
#ifndef OAIGuildCreateRequest_H
#define OAIGuildCreateRequest_H
...
namespace dc_rest {
class OAICreateGuildRequestRoleItem;
class OAICreateGuildRequestChannelItem;

class OAIGuildCreateRequest : public OAIObject {
public:
    OAIGuildCreateRequest();
    OAIGuildCreateRequest(QString json);
    ~OAIGuildCreateRequest() override;
    ...
    QList<OAICreateGuildRequestRoleItem> getRoles() const;
    void setRoles(const QList<OAICreateGuildRequestRoleItem> &roles);
    bool is_roles_Set() const;
    bool is_roles_Valid() const;

    QList<OAICreateGuildRequestChannelItem> getChannels() const;
    void setChannels(const QList<OAICreateGuildRequestChannelItem> &channels);
...
private:
    ...
    QList<OAICreateGuildRequestRoleItem> m_roles;
    bool m_roles_isSet;
    bool m_roles_isValid;

    QList<OAICreateGuildRequestChannelItem> m_channels;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildCreateRequest)

#endif // OAIGuildCreateRequest_H
