...
#ifndef OAIList_auto_moderation_rules_200_response_inner_H
#define OAIList_auto_moderation_rules_200_response_inner_H
...
class OAIList_auto_moderation_rules_200_response_inner : public OAIObject {
public:
    OAIList_auto_moderation_rules_200_response_inner();
    OAIList_auto_moderation_rules_200_response_inner(QString json);
    ~OAIList_auto_moderation_rules_200_response_inner() override;
    ...
    OAIObject getTriggerMetadata() const;
    void setTriggerMetadata(const OAIObject &trigger_metadata);
...
Q_DECLARE_METATYPE(dc_rest::OAIList_auto_moderation_rules_200_response_inner)

#endif // OAIList_auto_moderation_rules_200_response_inner_H
