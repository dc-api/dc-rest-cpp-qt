...
#ifndef OAICreate_thread_request_H
#define OAICreate_thread_request_H
...
class OAICreate_thread_request : public OAIObject {
public:
    OAICreate_thread_request();
    OAICreate_thread_request(QString json);
    ~OAICreate_thread_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreate_thread_request)

#endif // OAICreate_thread_request_H
