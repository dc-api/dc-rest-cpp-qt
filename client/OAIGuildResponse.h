...
#ifndef OAIGuildResponse_H
#define OAIGuildResponse_H
...
class OAIGuildResponse : public OAIObject {
public:
    OAIGuildResponse();
    OAIGuildResponse(QString json);
    ~OAIGuildResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildResponse)

#endif // OAIGuildResponse_H
