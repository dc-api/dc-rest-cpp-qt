...
#ifndef OAIExternalScheduledEventCreateRequest_H
#define OAIExternalScheduledEventCreateRequest_H
...
class OAIExternalScheduledEventCreateRequest : public OAIObject {
public:
    OAIExternalScheduledEventCreateRequest();
    OAIExternalScheduledEventCreateRequest(QString json);
    ~OAIExternalScheduledEventCreateRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIExternalScheduledEventCreateRequest)

#endif // OAIExternalScheduledEventCreateRequest_H
