...
#ifndef OAIPrivateGroupChannelResponse_H
#define OAIPrivateGroupChannelResponse_H
...
class OAIPrivateGroupChannelResponse : public OAIObject {
public:
    OAIPrivateGroupChannelResponse();
    OAIPrivateGroupChannelResponse(QString json);
    ~OAIPrivateGroupChannelResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIPrivateGroupChannelResponse)

#endif // OAIPrivateGroupChannelResponse_H
