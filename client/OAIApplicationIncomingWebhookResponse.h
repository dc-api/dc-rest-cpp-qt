...
#ifndef OAIApplicationIncomingWebhookResponse_H
#define OAIApplicationIncomingWebhookResponse_H
...
class OAIApplicationIncomingWebhookResponse : public OAIObject {
public:
    OAIApplicationIncomingWebhookResponse();
    OAIApplicationIncomingWebhookResponse(QString json);
    ~OAIApplicationIncomingWebhookResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationIncomingWebhookResponse)

#endif // OAIApplicationIncomingWebhookResponse_H
