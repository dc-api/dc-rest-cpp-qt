...
#ifndef OAIBaseCreateMessageCreateRequest_H
#define OAIBaseCreateMessageCreateRequest_H
...
class OAIBaseCreateMessageCreateRequest : public OAIObject {
public:
    OAIBaseCreateMessageCreateRequest();
    OAIBaseCreateMessageCreateRequest(QString json);
    ~OAIBaseCreateMessageCreateRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIBaseCreateMessageCreateRequest)

#endif // OAIBaseCreateMessageCreateRequest_H
