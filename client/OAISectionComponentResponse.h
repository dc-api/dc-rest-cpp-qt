...
#ifndef OAISectionComponentResponse_H
#define OAISectionComponentResponse_H
...
class OAISectionComponentResponse : public OAIObject {
public:
    OAISectionComponentResponse();
    OAISectionComponentResponse(QString json);
    ~OAISectionComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAISectionComponentResponse)

#endif // OAISectionComponentResponse_H
