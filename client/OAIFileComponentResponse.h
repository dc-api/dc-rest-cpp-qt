...
#ifndef OAIFileComponentResponse_H
#define OAIFileComponentResponse_H
...
class OAIFileComponentResponse : public OAIObject {
public:
    OAIFileComponentResponse();
    OAIFileComponentResponse(QString json);
    ~OAIFileComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIFileComponentResponse)

#endif // OAIFileComponentResponse_H
