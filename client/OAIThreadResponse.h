...
#ifndef OAIThreadResponse_H
#define OAIThreadResponse_H
...
class OAIThreadResponse : public OAIObject {
public:
    OAIThreadResponse();
    OAIThreadResponse(QString json);
    ~OAIThreadResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIThreadResponse)

#endif // OAIThreadResponse_H
