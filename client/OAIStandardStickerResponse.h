...
#ifndef OAIStandardStickerResponse_H
#define OAIStandardStickerResponse_H
...
class OAIStandardStickerResponse : public OAIObject {
public:
    OAIStandardStickerResponse();
    OAIStandardStickerResponse(QString json);
    ~OAIStandardStickerResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStandardStickerResponse)

#endif // OAIStandardStickerResponse_H
