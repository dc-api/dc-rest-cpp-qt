...
#ifndef OAIGuildTemplateChannelResponse_H
#define OAIGuildTemplateChannelResponse_H
...
class OAIGuildTemplateChannelTags;
class OAIDefaultReactionEmojiResponse;

class OAIGuildTemplateChannelResponse : public OAIObject {
public:
    OAIGuildTemplateChannelResponse();
    OAIGuildTemplateChannelResponse(QString json);
    ~OAIGuildTemplateChannelResponse() override;
    ...
    QList<OAIGuildTemplateChannelTags> getAvailableTags() const;
    void setAvailableTags(const QList<OAIGuildTemplateChannelTags> &available_tags);
    ...
    OAIObject getIconEmoji() const;
    void setIconEmoji(const OAIObject &icon_emoji);
    bool is_icon_emoji_Set() const;
    bool is_icon_emoji_Valid() const;

    qint32 getThemeColor() const;
    void setThemeColor(const qint32 &theme_color);
...
private:
    ...
    QList<OAIGuildTemplateChannelTags> m_available_tags;
    ...
    OAIObject m_icon_emoji;
    bool m_icon_emoji_isSet;
    bool m_icon_emoji_isValid;

    qint32 m_theme_color;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildTemplateChannelResponse)

#endif // OAIGuildTemplateChannelResponse_H
