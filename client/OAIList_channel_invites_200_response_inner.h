...
#ifndef OAIList_channel_invites_200_response_inner_H
#define OAIList_channel_invites_200_response_inner_H
...
class OAIList_channel_invites_200_response_inner : public OAIObject {
public:
    OAIList_channel_invites_200_response_inner();
    OAIList_channel_invites_200_response_inner(QString json);
    ~OAIList_channel_invites_200_response_inner() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIList_channel_invites_200_response_inner)

#endif // OAIList_channel_invites_200_response_inner_H
