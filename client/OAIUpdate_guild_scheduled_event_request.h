...
#ifndef OAIUpdate_guild_scheduled_event_request_H
#define OAIUpdate_guild_scheduled_event_request_H
...
class OAIUpdate_guild_scheduled_event_request : public OAIObject {
public:
    OAIUpdate_guild_scheduled_event_request();
    OAIUpdate_guild_scheduled_event_request(QString json);
    ~OAIUpdate_guild_scheduled_event_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUpdate_guild_scheduled_event_request)

#endif // OAIUpdate_guild_scheduled_event_request_H
