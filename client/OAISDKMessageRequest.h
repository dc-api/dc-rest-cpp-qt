...
#ifndef OAISDKMessageRequest_H
#define OAISDKMessageRequest_H
...
class OAISDKMessageRequest : public OAIObject {
public:
    OAISDKMessageRequest();
    OAISDKMessageRequest(QString json);
    ~OAISDKMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAISDKMessageRequest)

#endif // OAISDKMessageRequest_H
