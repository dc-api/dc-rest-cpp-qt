...
#ifndef OAIGithubRelease_H
#define OAIGithubRelease_H
...
class OAIGithubRelease : public OAIObject {
public:
    OAIGithubRelease();
    OAIGithubRelease(QString json);
    ~OAIGithubRelease() override;
    ...
    OAIGithubUser getAuthor() const;
    void setAuthor(const OAIGithubUser &author);
...
Q_DECLARE_METATYPE(dc_rest::OAIGithubRelease)

#endif // OAIGithubRelease_H
