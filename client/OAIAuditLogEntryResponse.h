...
#ifndef OAIAuditLogEntryResponse_H
#define OAIAuditLogEntryResponse_H
...
namespace dc_rest {
class OAIAuditLogObjectChangeResponse;

class OAIAuditLogEntryResponse : public OAIObject {
public:
    OAIAuditLogEntryResponse();
    OAIAuditLogEntryResponse(QString json);
    ~OAIAuditLogEntryResponse() override;
    ...
    QList<OAIAuditLogObjectChangeResponse> getChanges() const;
    void setChanges(const QList<OAIAuditLogObjectChangeResponse> &changes);
...
private:
    ...
    QList<OAIAuditLogObjectChangeResponse> m_changes;
...
Q_DECLARE_METATYPE(dc_rest::OAIAuditLogEntryResponse)

#endif // OAIAuditLogEntryResponse_H
