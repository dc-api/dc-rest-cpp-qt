...
#ifndef OAIApplicationCommandOptionIntegerChoiceResponse_H
#define OAIApplicationCommandOptionIntegerChoiceResponse_H
...
class OAIApplicationCommandOptionIntegerChoiceResponse : public OAIObject {
public:
    OAIApplicationCommandOptionIntegerChoiceResponse();
    OAIApplicationCommandOptionIntegerChoiceResponse(QString json);
    ~OAIApplicationCommandOptionIntegerChoiceResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandOptionIntegerChoiceResponse)

#endif // OAIApplicationCommandOptionIntegerChoiceResponse_H
