...
#ifndef OAIDefaultKeywordRuleResponse_H
#define OAIDefaultKeywordRuleResponse_H
...
class OAIDefaultKeywordListTriggerMetadataResponse;

class OAIDefaultKeywordRuleResponse : public OAIObject {
public:
    OAIDefaultKeywordRuleResponse();
    OAIDefaultKeywordRuleResponse(QString json);
    ~OAIDefaultKeywordRuleResponse() override;
    ...
    OAIDefaultKeywordListTriggerMetadataResponse getTriggerMetadata() const;
    void setTriggerMetadata(const OAIDefaultKeywordListTriggerMetadataResponse &trigger_metadata);
...
private:
    ...
    OAIDefaultKeywordListTriggerMetadataResponse m_trigger_metadata;
...
Q_DECLARE_METATYPE(dc_rest::OAIDefaultKeywordRuleResponse)

#endif // OAIDefaultKeywordRuleResponse_H
