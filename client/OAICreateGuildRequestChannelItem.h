...
#ifndef OAICreateGuildRequestChannelItem_H
#define OAICreateGuildRequestChannelItem_H
...
class OAICreateOrUpdateThreadTagRequest;

class OAICreateGuildRequestChannelItem : public OAIObject {
public:
    OAICreateGuildRequestChannelItem();
    OAICreateGuildRequestChannelItem(QString json);
    ~OAICreateGuildRequestChannelItem() override;
    ...
    QList<OAICreateOrUpdateThreadTagRequest> getAvailableTags() const;
    void setAvailableTags(const QList<OAICreateOrUpdateThreadTagRequest> &available_tags);
...
private:
    ...
    QList<OAICreateOrUpdateThreadTagRequest> m_available_tags;
...
Q_DECLARE_METATYPE(dc_rest::OAICreateGuildRequestChannelItem)

#endif // OAICreateGuildRequestChannelItem_H
