...
#ifndef OAIMessageReferenceResponse_H
#define OAIMessageReferenceResponse_H
...
class OAIMessageReferenceResponse : public OAIObject {
public:
    OAIMessageReferenceResponse();
    OAIMessageReferenceResponse(QString json);
    ~OAIMessageReferenceResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageReferenceResponse)

#endif // OAIMessageReferenceResponse_H
