...
#ifndef OAIMentionSpamUpsertRequestPartial_H
#define OAIMentionSpamUpsertRequestPartial_H
...
class OAIMentionSpamUpsertRequestPartial : public OAIObject {
public:
    OAIMentionSpamUpsertRequestPartial();
    OAIMentionSpamUpsertRequestPartial(QString json);
    ~OAIMentionSpamUpsertRequestPartial() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMentionSpamUpsertRequestPartial)

#endif // OAIMentionSpamUpsertRequestPartial_H
