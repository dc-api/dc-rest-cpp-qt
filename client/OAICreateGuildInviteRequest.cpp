...
OAICreateGuildInviteRequest::OAICreateGuildInviteRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGuildInviteRequest::OAICreateGuildInviteRequest() {
    this->initializeModel();
}

OAICreateGuildInviteRequest::~OAICreateGuildInviteRequest() {}

void OAICreateGuildInviteRequest::initializeModel() {
...
void OAICreateGuildInviteRequest::fromJson(QString jsonString) {
...
void OAICreateGuildInviteRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateGuildInviteRequest::asJson() const {
...
QJsonObject OAICreateGuildInviteRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_max_age_isSet) {
...
qint32 OAICreateGuildInviteRequest::getMaxAge() const {
    return m_max_age;
}
void OAICreateGuildInviteRequest::setMaxAge(const qint32 &max_age) {
    m_max_age = max_age;
    m_max_age_isSet = true;
}

bool OAICreateGuildInviteRequest::is_max_age_Set() const{
    return m_max_age_isSet;
}

bool OAICreateGuildInviteRequest::is_max_age_Valid() const{
    return m_max_age_isValid;
}

bool OAICreateGuildInviteRequest::isTemporary() const {
    return m_temporary;
}
void OAICreateGuildInviteRequest::setTemporary(const bool &temporary) {
    m_temporary = temporary;
    m_temporary_isSet = true;
}

bool OAICreateGuildInviteRequest::is_temporary_Set() const{
    return m_temporary_isSet;
}

bool OAICreateGuildInviteRequest::is_temporary_Valid() const{
    return m_temporary_isValid;
}

qint32 OAICreateGuildInviteRequest::getMaxUses() const {
    return m_max_uses;
}
void OAICreateGuildInviteRequest::setMaxUses(const qint32 &max_uses) {
    m_max_uses = max_uses;
    m_max_uses_isSet = true;
}

bool OAICreateGuildInviteRequest::is_max_uses_Set() const{
    return m_max_uses_isSet;
}

bool OAICreateGuildInviteRequest::is_max_uses_Valid() const{
    return m_max_uses_isValid;
}

bool OAICreateGuildInviteRequest::isUnique() const {
    return m_unique;
}
void OAICreateGuildInviteRequest::setUnique(const bool &unique) {
    m_unique = unique;
    m_unique_isSet = true;
}

bool OAICreateGuildInviteRequest::is_unique_Set() const{
    return m_unique_isSet;
}

bool OAICreateGuildInviteRequest::is_unique_Valid() const{
    return m_unique_isValid;
}

QString OAICreateGuildInviteRequest::getTargetUserId() const {
    return m_target_user_id;
}
void OAICreateGuildInviteRequest::setTargetUserId(const QString &target_user_id) {
    m_target_user_id = target_user_id;
    m_target_user_id_isSet = true;
}

bool OAICreateGuildInviteRequest::is_target_user_id_Set() const{
    return m_target_user_id_isSet;
}

bool OAICreateGuildInviteRequest::is_target_user_id_Valid() const{
    return m_target_user_id_isValid;
}

QString OAICreateGuildInviteRequest::getTargetApplicationId() const {
    return m_target_application_id;
}
void OAICreateGuildInviteRequest::setTargetApplicationId(const QString &target_application_id) {
    m_target_application_id = target_application_id;
    m_target_application_id_isSet = true;
}

bool OAICreateGuildInviteRequest::is_target_application_id_Set() const{
    return m_target_application_id_isSet;
}

bool OAICreateGuildInviteRequest::is_target_application_id_Valid() const{
    return m_target_application_id_isValid;
}

qint32 OAICreateGuildInviteRequest::getTargetType() const {
    return m_target_type;
}
void OAICreateGuildInviteRequest::setTargetType(const qint32 &target_type) {
    m_target_type = target_type;
    m_target_type_isSet = true;
}

bool OAICreateGuildInviteRequest::is_target_type_Set() const{
    return m_target_type_isSet;
}

bool OAICreateGuildInviteRequest::is_target_type_Valid() const{
    return m_target_type_isValid;
}

bool OAICreateGuildInviteRequest::isSet() const {
...
bool OAICreateGuildInviteRequest::isValid() const {
