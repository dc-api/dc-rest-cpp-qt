...
#ifndef OAIMessageEditRequestPartial_H
#define OAIMessageEditRequestPartial_H
...
class OAIMessageEditRequestPartial : public OAIObject {
public:
    OAIMessageEditRequestPartial();
    OAIMessageEditRequestPartial(QString json);
    ~OAIMessageEditRequestPartial() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageEditRequestPartial)

#endif // OAIMessageEditRequestPartial_H
