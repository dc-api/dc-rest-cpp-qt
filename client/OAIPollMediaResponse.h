...
#ifndef OAIPollMediaResponse_H
#define OAIPollMediaResponse_H
...
class OAIPollMediaResponse : public OAIObject {
public:
    OAIPollMediaResponse();
    OAIPollMediaResponse(QString json);
    ~OAIPollMediaResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIPollMediaResponse)

#endif // OAIPollMediaResponse_H
