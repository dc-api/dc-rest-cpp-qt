...
#ifndef OAIApplicationCommandIntegerOptionResponse_H
#define OAIApplicationCommandIntegerOptionResponse_H
...
namespace dc_rest {
class OAIApplicationCommandOptionIntegerChoiceResponse;

class OAIApplicationCommandIntegerOptionResponse : public OAIObject {
public:
    OAIApplicationCommandIntegerOptionResponse();
    OAIApplicationCommandIntegerOptionResponse(QString json);
    ~OAIApplicationCommandIntegerOptionResponse() override;
    ...
    QList<OAIApplicationCommandOptionIntegerChoiceResponse> getChoices() const;
    void setChoices(const QList<OAIApplicationCommandOptionIntegerChoiceResponse> &choices);
    bool is_choices_Set() const;
    bool is_choices_Valid() const;

    qint64 getMinValue() const;
    void setMinValue(const qint64 &min_value);
...
private:
    ...
    QList<OAIApplicationCommandOptionIntegerChoiceResponse> m_choices;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandIntegerOptionResponse)

#endif // OAIApplicationCommandIntegerOptionResponse_H
