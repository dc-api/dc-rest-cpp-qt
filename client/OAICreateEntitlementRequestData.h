...
#ifndef OAICreateEntitlementRequestData_H
#define OAICreateEntitlementRequestData_H
...
class OAICreateEntitlementRequestData : public OAIObject {
public:
    OAICreateEntitlementRequestData();
    OAICreateEntitlementRequestData(QString json);
    ~OAICreateEntitlementRequestData() override;
    ...
    qint32 getOwnerType() const;
    void setOwnerType(const qint32 &owner_type);
...
Q_DECLARE_METATYPE(dc_rest::OAICreateEntitlementRequestData)

#endif // OAICreateEntitlementRequestData_H
