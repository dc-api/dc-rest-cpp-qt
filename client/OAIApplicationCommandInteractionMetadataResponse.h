...
#ifndef OAIApplicationCommandInteractionMetadataResponse_H
#define OAIApplicationCommandInteractionMetadataResponse_H
...
class OAIApplicationCommandInteractionMetadataResponse : public OAIObject {
public:
    OAIApplicationCommandInteractionMetadataResponse();
    OAIApplicationCommandInteractionMetadataResponse(QString json);
    ~OAIApplicationCommandInteractionMetadataResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandInteractionMetadataResponse)

#endif // OAIApplicationCommandInteractionMetadataResponse_H
