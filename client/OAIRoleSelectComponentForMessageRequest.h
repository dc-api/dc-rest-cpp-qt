...
#ifndef OAIRoleSelectComponentForMessageRequest_H
#define OAIRoleSelectComponentForMessageRequest_H
...
namespace dc_rest {
class OAIRoleSelectDefaultValue;

class OAIRoleSelectComponentForMessageRequest : public OAIObject {
public:
    OAIRoleSelectComponentForMessageRequest();
    OAIRoleSelectComponentForMessageRequest(QString json);
    ~OAIRoleSelectComponentForMessageRequest() override;
    ...
    QList<OAIRoleSelectDefaultValue> getDefaultValues() const;
    void setDefaultValues(const QList<OAIRoleSelectDefaultValue> &default_values);
...
private:
    ...
    QList<OAIRoleSelectDefaultValue> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIRoleSelectComponentForMessageRequest)

#endif // OAIRoleSelectComponentForMessageRequest_H
