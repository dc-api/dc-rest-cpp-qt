...
#ifndef OAIButtonComponentForMessageRequest_H
#define OAIButtonComponentForMessageRequest_H
...
class OAIButtonComponentForMessageRequest : public OAIObject {
public:
    OAIButtonComponentForMessageRequest();
    OAIButtonComponentForMessageRequest(QString json);
    ~OAIButtonComponentForMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIButtonComponentForMessageRequest)

#endif // OAIButtonComponentForMessageRequest_H
