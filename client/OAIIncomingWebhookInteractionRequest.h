...
#ifndef OAIIncomingWebhookInteractionRequest_H
#define OAIIncomingWebhookInteractionRequest_H
...
class OAIIncomingWebhookInteractionRequest : public OAIObject {
public:
    OAIIncomingWebhookInteractionRequest();
    OAIIncomingWebhookInteractionRequest(QString json);
    ~OAIIncomingWebhookInteractionRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIIncomingWebhookInteractionRequest)

#endif // OAIIncomingWebhookInteractionRequest_H
