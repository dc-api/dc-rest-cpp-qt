...
#ifndef OAIApplicationCommandChannelOptionResponse_H
#define OAIApplicationCommandChannelOptionResponse_H
...
class OAIApplicationCommandChannelOptionResponse : public OAIObject {
public:
    OAIApplicationCommandChannelOptionResponse();
    OAIApplicationCommandChannelOptionResponse(QString json);
    ~OAIApplicationCommandChannelOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandChannelOptionResponse)

#endif // OAIApplicationCommandChannelOptionResponse_H
