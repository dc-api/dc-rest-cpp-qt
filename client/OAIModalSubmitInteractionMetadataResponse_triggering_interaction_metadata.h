...
#ifndef OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata_H
#define OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata_H
...
class OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata : public OAIObject {
public:
    OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata();
    OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata(QString json);
    ~OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata)

#endif // OAIModalSubmitInteractionMetadataResponse_triggering_interaction_metadata_H
