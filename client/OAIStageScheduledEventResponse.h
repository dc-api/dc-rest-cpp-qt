...
#ifndef OAIStageScheduledEventResponse_H
#define OAIStageScheduledEventResponse_H
...
class OAIStageScheduledEventResponse : public OAIObject {
public:
    OAIStageScheduledEventResponse();
    OAIStageScheduledEventResponse(QString json);
    ~OAIStageScheduledEventResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStageScheduledEventResponse)

#endif // OAIStageScheduledEventResponse_H
