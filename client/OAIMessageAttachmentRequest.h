...
#ifndef OAIMessageAttachmentRequest_H
#define OAIMessageAttachmentRequest_H
...
class OAIMessageAttachmentRequest : public OAIObject {
public:
    OAIMessageAttachmentRequest();
    OAIMessageAttachmentRequest(QString json);
    ~OAIMessageAttachmentRequest() override;
    ...
    bool isIsRemix() const;
    void setIsRemix(const bool &is_remix);
    bool is_is_remix_Set() const;
    bool is_is_remix_Valid() const;
...
private:
    ...
    bool m_is_remix;
    bool m_is_remix_isSet;
    bool m_is_remix_isValid;
};

} // namespace dc_rest

Q_DECLARE_METATYPE(dc_rest::OAIMessageAttachmentRequest)

#endif // OAIMessageAttachmentRequest_H
