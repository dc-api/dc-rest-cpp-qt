...
#ifndef OAIUpdate_self_voice_state_request_H
#define OAIUpdate_self_voice_state_request_H
...
class OAIUpdate_self_voice_state_request : public OAIObject {
public:
    OAIUpdate_self_voice_state_request();
    OAIUpdate_self_voice_state_request(QString json);
    ~OAIUpdate_self_voice_state_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUpdate_self_voice_state_request)

#endif // OAIUpdate_self_voice_state_request_H
