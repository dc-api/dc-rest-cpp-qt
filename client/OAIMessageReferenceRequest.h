...
#ifndef OAIMessageReferenceRequest_H
#define OAIMessageReferenceRequest_H
...
class OAIMessageReferenceRequest : public OAIObject {
public:
    OAIMessageReferenceRequest();
    OAIMessageReferenceRequest(QString json);
    ~OAIMessageReferenceRequest() override;
    ...
    bool isFailIfNotExists() const;
    void setFailIfNotExists(const bool &fail_if_not_exists);
    bool is_fail_if_not_exists_Set() const;
    bool is_fail_if_not_exists_Valid() const;
...
private:
    ...
    bool m_fail_if_not_exists;
    bool m_fail_if_not_exists_isSet;
    bool m_fail_if_not_exists_isValid;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageReferenceRequest)

#endif // OAIMessageReferenceRequest_H
