...
#ifndef OAIMentionSpamUpsertRequest_H
#define OAIMentionSpamUpsertRequest_H
...
class OAIMentionSpamUpsertRequest : public OAIObject {
public:
    OAIMentionSpamUpsertRequest();
    OAIMentionSpamUpsertRequest(QString json);
    ~OAIMentionSpamUpsertRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMentionSpamUpsertRequest)

#endif // OAIMentionSpamUpsertRequest_H
