...
#ifndef OAIMessageComponentInteractionMetadataResponse_H
#define OAIMessageComponentInteractionMetadataResponse_H
...
class OAIMessageComponentInteractionMetadataResponse : public OAIObject {
public:
    OAIMessageComponentInteractionMetadataResponse();
    OAIMessageComponentInteractionMetadataResponse(QString json);
    ~OAIMessageComponentInteractionMetadataResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageComponentInteractionMetadataResponse)

#endif // OAIMessageComponentInteractionMetadataResponse_H
