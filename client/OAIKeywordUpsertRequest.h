...
#ifndef OAIKeywordUpsertRequest_H
#define OAIKeywordUpsertRequest_H
...
class OAIKeywordUpsertRequest : public OAIObject {
public:
    OAIKeywordUpsertRequest();
    OAIKeywordUpsertRequest(QString json);
    ~OAIKeywordUpsertRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIKeywordUpsertRequest)

#endif // OAIKeywordUpsertRequest_H
