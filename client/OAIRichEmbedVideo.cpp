...
OAIRichEmbedVideo::OAIRichEmbedVideo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRichEmbedVideo::OAIRichEmbedVideo() {
    this->initializeModel();
}

OAIRichEmbedVideo::~OAIRichEmbedVideo() {}

void OAIRichEmbedVideo::initializeModel() {
...
void OAIRichEmbedVideo::fromJson(QString jsonString) {
...
void OAIRichEmbedVideo::fromJsonObject(QJsonObject json) {
...
QString OAIRichEmbedVideo::asJson() const {
...
QJsonObject OAIRichEmbedVideo::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAIRichEmbedVideo::getUrl() const {
    return m_url;
}
void OAIRichEmbedVideo::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIRichEmbedVideo::is_url_Set() const{
    return m_url_isSet;
}

bool OAIRichEmbedVideo::is_url_Valid() const{
    return m_url_isValid;
}

qint32 OAIRichEmbedVideo::getWidth() const {
    return m_width;
}
void OAIRichEmbedVideo::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIRichEmbedVideo::is_width_Set() const{
    return m_width_isSet;
}

bool OAIRichEmbedVideo::is_width_Valid() const{
    return m_width_isValid;
}

qint32 OAIRichEmbedVideo::getHeight() const {
    return m_height;
}
void OAIRichEmbedVideo::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIRichEmbedVideo::is_height_Set() const{
    return m_height_isSet;
}

bool OAIRichEmbedVideo::is_height_Valid() const{
    return m_height_isValid;
}

QString OAIRichEmbedVideo::getPlaceholder() const {
    return m_placeholder;
}
void OAIRichEmbedVideo::setPlaceholder(const QString &placeholder) {
    m_placeholder = placeholder;
    m_placeholder_isSet = true;
}

bool OAIRichEmbedVideo::is_placeholder_Set() const{
    return m_placeholder_isSet;
}

bool OAIRichEmbedVideo::is_placeholder_Valid() const{
    return m_placeholder_isValid;
}

qint32 OAIRichEmbedVideo::getPlaceholderVersion() const {
    return m_placeholder_version;
}
void OAIRichEmbedVideo::setPlaceholderVersion(const qint32 &placeholder_version) {
    m_placeholder_version = placeholder_version;
    m_placeholder_version_isSet = true;
}

bool OAIRichEmbedVideo::is_placeholder_version_Set() const{
    return m_placeholder_version_isSet;
}

bool OAIRichEmbedVideo::is_placeholder_version_Valid() const{
    return m_placeholder_version_isValid;
}

bool OAIRichEmbedVideo::isIsAnimated() const {
    return m_is_animated;
}
void OAIRichEmbedVideo::setIsAnimated(const bool &is_animated) {
    m_is_animated = is_animated;
    m_is_animated_isSet = true;
}

bool OAIRichEmbedVideo::is_is_animated_Set() const{
    return m_is_animated_isSet;
}

bool OAIRichEmbedVideo::is_is_animated_Valid() const{
    return m_is_animated_isValid;
}

QString OAIRichEmbedVideo::getDescription() const {
    return m_description;
}
void OAIRichEmbedVideo::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRichEmbedVideo::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRichEmbedVideo::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIRichEmbedVideo::isSet() const {
...
bool OAIRichEmbedVideo::isValid() const {
