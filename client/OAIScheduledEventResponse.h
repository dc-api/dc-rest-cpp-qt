...
#ifndef OAIScheduledEventResponse_H
#define OAIScheduledEventResponse_H
...
class OAIScheduledEventResponse : public OAIObject {
public:
    OAIScheduledEventResponse();
    OAIScheduledEventResponse(QString json);
    ~OAIScheduledEventResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIScheduledEventResponse)

#endif // OAIScheduledEventResponse_H
