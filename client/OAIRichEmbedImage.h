...
#ifndef OAIRichEmbedImage_H
#define OAIRichEmbedImage_H
...
class OAIRichEmbedImage : public OAIObject {
public:
    OAIRichEmbedImage();
    OAIRichEmbedImage(QString json);
    ~OAIRichEmbedImage() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIRichEmbedImage)

#endif // OAIRichEmbedImage_H
