...
#ifndef OAIStringSelectComponentForMessageRequest_H
#define OAIStringSelectComponentForMessageRequest_H
...
class OAIStringSelectComponentForMessageRequest : public OAIObject {
public:
    OAIStringSelectComponentForMessageRequest();
    OAIStringSelectComponentForMessageRequest(QString json);
    ~OAIStringSelectComponentForMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStringSelectComponentForMessageRequest)

#endif // OAIStringSelectComponentForMessageRequest_H
