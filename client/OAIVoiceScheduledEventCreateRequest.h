...
#ifndef OAIVoiceScheduledEventCreateRequest_H
#define OAIVoiceScheduledEventCreateRequest_H
...
class OAIVoiceScheduledEventCreateRequest : public OAIObject {
public:
    OAIVoiceScheduledEventCreateRequest();
    OAIVoiceScheduledEventCreateRequest(QString json);
    ~OAIVoiceScheduledEventCreateRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIVoiceScheduledEventCreateRequest)

#endif // OAIVoiceScheduledEventCreateRequest_H
