...
#ifndef OAIList_channel_webhooks_200_response_inner_H
#define OAIList_channel_webhooks_200_response_inner_H
...
#include "OAIWebhookSourceChannelResponse.h"
...
class OAIWebhookSourceGuildResponse;
class OAIWebhookSourceChannelResponse;

class OAIList_channel_webhooks_200_response_inner : public OAIObject {
public:
    OAIList_channel_webhooks_200_response_inner();
    OAIList_channel_webhooks_200_response_inner(QString json);
    ~OAIList_channel_webhooks_200_response_inner() override;
    ...
    OAIWebhookSourceGuildResponse getSourceGuild() const;
    void setSourceGuild(const OAIWebhookSourceGuildResponse &source_guild);
    bool is_source_guild_Set() const;
    bool is_source_guild_Valid() const;

    OAIWebhookSourceChannelResponse getSourceChannel() const;
    void setSourceChannel(const OAIWebhookSourceChannelResponse &source_channel);
...
private:
    ...
    OAIWebhookSourceGuildResponse m_source_guild;
    bool m_source_guild_isSet;
    bool m_source_guild_isValid;

    OAIWebhookSourceChannelResponse m_source_channel;
...
Q_DECLARE_METATYPE(dc_rest::OAIList_channel_webhooks_200_response_inner)

#endif // OAIList_channel_webhooks_200_response_inner_H
