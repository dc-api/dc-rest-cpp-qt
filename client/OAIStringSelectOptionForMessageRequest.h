...
#ifndef OAIStringSelectOptionForMessageRequest_H
#define OAIStringSelectOptionForMessageRequest_H
...
class OAIStringSelectOptionForMessageRequest : public OAIObject {
public:
    OAIStringSelectOptionForMessageRequest();
    OAIStringSelectOptionForMessageRequest(QString json);
    ~OAIStringSelectOptionForMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStringSelectOptionForMessageRequest)

#endif // OAIStringSelectOptionForMessageRequest_H
