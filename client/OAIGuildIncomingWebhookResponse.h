...
#ifndef OAIGuildIncomingWebhookResponse_H
#define OAIGuildIncomingWebhookResponse_H
...
class OAIGuildIncomingWebhookResponse : public OAIObject {
public:
    OAIGuildIncomingWebhookResponse();
    OAIGuildIncomingWebhookResponse(QString json);
    ~OAIGuildIncomingWebhookResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildIncomingWebhookResponse)

#endif // OAIGuildIncomingWebhookResponse_H
