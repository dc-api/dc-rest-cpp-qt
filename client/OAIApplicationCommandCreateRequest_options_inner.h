...
#ifndef OAIApplicationCommandCreateRequest_options_inner_H
#define OAIApplicationCommandCreateRequest_options_inner_H
...
namespace dc_rest {
class OAIApplicationCommandOptionStringChoice;
class OAIApplicationCommandSubcommandOption_options_inner;

class OAIApplicationCommandCreateRequest_options_inner : public OAIObject {
public:
    OAIApplicationCommandCreateRequest_options_inner();
    OAIApplicationCommandCreateRequest_options_inner(QString json);
    ~OAIApplicationCommandCreateRequest_options_inner() override;
    ...
    QList<OAIApplicationCommandOptionStringChoice> getChoices() const;
    void setChoices(const QList<OAIApplicationCommandOptionStringChoice> &choices);
    ...
    QList<OAIApplicationCommandSubcommandOption_options_inner> getOptions() const;
    void setOptions(const QList<OAIApplicationCommandSubcommandOption_options_inner> &options);
...
private:
    ...
    QList<OAIApplicationCommandOptionStringChoice> m_choices;
    ...
    QList<OAIApplicationCommandSubcommandOption_options_inner> m_options;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandCreateRequest_options_inner)

#endif // OAIApplicationCommandCreateRequest_options_inner_H
