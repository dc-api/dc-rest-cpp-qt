...
#ifndef OAISeparatorComponentResponse_H
#define OAISeparatorComponentResponse_H
...
class OAISeparatorComponentResponse : public OAIObject {
public:
    OAISeparatorComponentResponse();
    OAISeparatorComponentResponse(QString json);
    ~OAISeparatorComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAISeparatorComponentResponse)

#endif // OAISeparatorComponentResponse_H
