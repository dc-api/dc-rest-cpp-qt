...
#ifndef OAICreateGuildRequestRoleItem_H
#define OAICreateGuildRequestRoleItem_H
...
class OAICreateGuildRequestRoleItem : public OAIObject {
public:
    OAICreateGuildRequestRoleItem();
    OAICreateGuildRequestRoleItem(QString json);
    ~OAICreateGuildRequestRoleItem() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreateGuildRequestRoleItem)

#endif // OAICreateGuildRequestRoleItem_H
