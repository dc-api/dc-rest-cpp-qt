...
#ifndef OAIApplicationCommandSubcommandOption_H
#define OAIApplicationCommandSubcommandOption_H
...
class OAIApplicationCommandSubcommandOption : public OAIObject {
public:
    OAIApplicationCommandSubcommandOption();
    OAIApplicationCommandSubcommandOption(QString json);
    ~OAIApplicationCommandSubcommandOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandSubcommandOption)

#endif // OAIApplicationCommandSubcommandOption_H
