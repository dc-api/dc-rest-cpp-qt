...
#ifndef OAIChannelFollowerWebhookResponse_H
#define OAIChannelFollowerWebhookResponse_H
...
class OAIChannelFollowerWebhookResponse : public OAIObject {
public:
    OAIChannelFollowerWebhookResponse();
    OAIChannelFollowerWebhookResponse(QString json);
    ~OAIChannelFollowerWebhookResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIChannelFollowerWebhookResponse)

#endif // OAIChannelFollowerWebhookResponse_H
