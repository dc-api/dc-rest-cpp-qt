...
#include "OAIKeywordRuleResponse.h"
...
OAIKeywordRuleResponse::OAIKeywordRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeywordRuleResponse::OAIKeywordRuleResponse() {
    this->initializeModel();
}

OAIKeywordRuleResponse::~OAIKeywordRuleResponse() {}

void OAIKeywordRuleResponse::initializeModel() {
...
void OAIKeywordRuleResponse::fromJson(QString jsonString) {
...
void OAIKeywordRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAIKeywordRuleResponse::asJson() const {
...
QJsonObject OAIKeywordRuleResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIKeywordRuleResponse::getId() const {
    return m_id;
}
void OAIKeywordRuleResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKeywordRuleResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKeywordRuleResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIKeywordRuleResponse::getGuildId() const {
    return m_guild_id;
}
void OAIKeywordRuleResponse::setGuildId(const QString &guild_id) {
    m_guild_id = guild_id;
    m_guild_id_isSet = true;
}

bool OAIKeywordRuleResponse::is_guild_id_Set() const{
    return m_guild_id_isSet;
}

bool OAIKeywordRuleResponse::is_guild_id_Valid() const{
    return m_guild_id_isValid;
}

QString OAIKeywordRuleResponse::getCreatorId() const {
    return m_creator_id;
}
void OAIKeywordRuleResponse::setCreatorId(const QString &creator_id) {
    m_creator_id = creator_id;
    m_creator_id_isSet = true;
}

bool OAIKeywordRuleResponse::is_creator_id_Set() const{
    return m_creator_id_isSet;
}

bool OAIKeywordRuleResponse::is_creator_id_Valid() const{
    return m_creator_id_isValid;
}

QString OAIKeywordRuleResponse::getName() const {
    return m_name;
}
void OAIKeywordRuleResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIKeywordRuleResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIKeywordRuleResponse::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIKeywordRuleResponse::getEventType() const {
    return m_event_type;
}
void OAIKeywordRuleResponse::setEventType(const qint32 &event_type) {
    m_event_type = event_type;
    m_event_type_isSet = true;
}

bool OAIKeywordRuleResponse::is_event_type_Set() const{
    return m_event_type_isSet;
}

bool OAIKeywordRuleResponse::is_event_type_Valid() const{
    return m_event_type_isValid;
}

QList<OAIDefaultKeywordRuleResponse_actions_inner> OAIKeywordRuleResponse::getActions() const {
    return m_actions;
}
void OAIKeywordRuleResponse::setActions(const QList<OAIDefaultKeywordRuleResponse_actions_inner> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIKeywordRuleResponse::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIKeywordRuleResponse::is_actions_Valid() const{
    return m_actions_isValid;
}

qint32 OAIKeywordRuleResponse::getTriggerType() const {
    return m_trigger_type;
}
void OAIKeywordRuleResponse::setTriggerType(const qint32 &trigger_type) {
    m_trigger_type = trigger_type;
    m_trigger_type_isSet = true;
}

bool OAIKeywordRuleResponse::is_trigger_type_Set() const{
    return m_trigger_type_isSet;
}

bool OAIKeywordRuleResponse::is_trigger_type_Valid() const{
    return m_trigger_type_isValid;
}

OAIKeywordTriggerMetadataResponse OAIKeywordRuleResponse::getTriggerMetadata() const {
    return m_trigger_metadata;
}
void OAIKeywordRuleResponse::setTriggerMetadata(const OAIKeywordTriggerMetadataResponse &trigger_metadata) {
    m_trigger_metadata = trigger_metadata;
    m_trigger_metadata_isSet = true;
}

bool OAIKeywordRuleResponse::is_trigger_metadata_Set() const{
    return m_trigger_metadata_isSet;
}

bool OAIKeywordRuleResponse::is_trigger_metadata_Valid() const{
    return m_trigger_metadata_isValid;
}

bool OAIKeywordRuleResponse::isEnabled() const {
    return m_enabled;
}
void OAIKeywordRuleResponse::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIKeywordRuleResponse::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIKeywordRuleResponse::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QSet<QString> OAIKeywordRuleResponse::getExemptRoles() const {
    return m_exempt_roles;
}
void OAIKeywordRuleResponse::setExemptRoles(const QSet<QString> &exempt_roles) {
    m_exempt_roles = exempt_roles;
    m_exempt_roles_isSet = true;
}

bool OAIKeywordRuleResponse::is_exempt_roles_Set() const{
    return m_exempt_roles_isSet;
}

bool OAIKeywordRuleResponse::is_exempt_roles_Valid() const{
    return m_exempt_roles_isValid;
}

QSet<QString> OAIKeywordRuleResponse::getExemptChannels() const {
    return m_exempt_channels;
}
void OAIKeywordRuleResponse::setExemptChannels(const QSet<QString> &exempt_channels) {
    m_exempt_channels = exempt_channels;
    m_exempt_channels_isSet = true;
}

bool OAIKeywordRuleResponse::is_exempt_channels_Set() const{
    return m_exempt_channels_isSet;
}

bool OAIKeywordRuleResponse::is_exempt_channels_Valid() const{
    return m_exempt_channels_isValid;
}

bool OAIKeywordRuleResponse::isSet() const {
...
bool OAIKeywordRuleResponse::isValid() const {
