...
#ifndef OAIExternalScheduledEventPatchRequestPartial_H
#define OAIExternalScheduledEventPatchRequestPartial_H
...
namespace dc_rest {
class OAIEntityMetadataExternal;

class OAIExternalScheduledEventPatchRequestPartial : public OAIObject {
public:
    OAIExternalScheduledEventPatchRequestPartial();
    OAIExternalScheduledEventPatchRequestPartial(QString json);
    ~OAIExternalScheduledEventPatchRequestPartial() override;
    ...
    OAIEntityMetadataExternal getEntityMetadata() const;
    void setEntityMetadata(const OAIEntityMetadataExternal &entity_metadata);
...
private:
    ...
    OAIEntityMetadataExternal m_entity_metadata;
...
Q_DECLARE_METATYPE(dc_rest::OAIExternalScheduledEventPatchRequestPartial)

#endif // OAIExternalScheduledEventPatchRequestPartial_H
