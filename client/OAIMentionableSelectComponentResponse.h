...
#ifndef OAIMentionableSelectComponentResponse_H
#define OAIMentionableSelectComponentResponse_H
...
namespace dc_rest {
class OAIMentionableSelectComponentResponse_default_values_inner;

class OAIMentionableSelectComponentResponse : public OAIObject {
public:
    OAIMentionableSelectComponentResponse();
    OAIMentionableSelectComponentResponse(QString json);
    ~OAIMentionableSelectComponentResponse() override;
    ...
    QList<OAIMentionableSelectComponentResponse_default_values_inner> getDefaultValues() const;
    void setDefaultValues(const QList<OAIMentionableSelectComponentResponse_default_values_inner> &default_values);
...
private:
    ...
    QList<OAIMentionableSelectComponentResponse_default_values_inner> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIMentionableSelectComponentResponse)

#endif // OAIMentionableSelectComponentResponse_H
