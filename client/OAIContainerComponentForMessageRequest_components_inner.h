...
#ifndef OAIContainerComponentForMessageRequest_components_inner_H
#define OAIContainerComponentForMessageRequest_components_inner_H
...
class OAIContainerComponentForMessageRequest_components_inner : public OAIObject {
public:
    OAIContainerComponentForMessageRequest_components_inner();
    OAIContainerComponentForMessageRequest_components_inner(QString json);
    ~OAIContainerComponentForMessageRequest_components_inner() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIContainerComponentForMessageRequest_components_inner)

#endif // OAIContainerComponentForMessageRequest_components_inner_H
