...
#ifndef OAICreateGuildInviteRequest_H
#define OAICreateGuildInviteRequest_H
...
class OAICreateGuildInviteRequest : public OAIObject {
public:
    OAICreateGuildInviteRequest();
    OAICreateGuildInviteRequest(QString json);
    ~OAICreateGuildInviteRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreateGuildInviteRequest)

#endif // OAICreateGuildInviteRequest_H
