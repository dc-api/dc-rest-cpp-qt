...
#ifndef OAIApplicationCommandBooleanOption_H
#define OAIApplicationCommandBooleanOption_H
...
class OAIApplicationCommandBooleanOption : public OAIObject {
public:
    OAIApplicationCommandBooleanOption();
    OAIApplicationCommandBooleanOption(QString json);
    ~OAIApplicationCommandBooleanOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandBooleanOption)

#endif // OAIApplicationCommandBooleanOption_H
