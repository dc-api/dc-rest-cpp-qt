...
#ifndef OAIExecute_webhook_request_H
#define OAIExecute_webhook_request_H
...
class OAIExecute_webhook_request : public OAIObject {
public:
    OAIExecute_webhook_request();
    OAIExecute_webhook_request(QString json);
    ~OAIExecute_webhook_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIExecute_webhook_request)

#endif // OAIExecute_webhook_request_H
