...
#ifndef OAIOnboardingPromptResponse_H
#define OAIOnboardingPromptResponse_H
...
namespace dc_rest {
class OAIOnboardingPromptOptionResponse;

class OAIOnboardingPromptResponse : public OAIObject {
public:
    OAIOnboardingPromptResponse();
    OAIOnboardingPromptResponse(QString json);
    ~OAIOnboardingPromptResponse() override;
    ...
    QList<OAIOnboardingPromptOptionResponse> getOptions() const;
    void setOptions(const QList<OAIOnboardingPromptOptionResponse> &options);
...
private:
    ...
    QList<OAIOnboardingPromptOptionResponse> m_options;
...
Q_DECLARE_METATYPE(dc_rest::OAIOnboardingPromptResponse)

#endif // OAIOnboardingPromptResponse_H
