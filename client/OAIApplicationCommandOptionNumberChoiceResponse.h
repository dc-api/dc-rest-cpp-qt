...
#ifndef OAIApplicationCommandOptionNumberChoiceResponse_H
#define OAIApplicationCommandOptionNumberChoiceResponse_H
...
class OAIApplicationCommandOptionNumberChoiceResponse : public OAIObject {
public:
    OAIApplicationCommandOptionNumberChoiceResponse();
    OAIApplicationCommandOptionNumberChoiceResponse(QString json);
    ~OAIApplicationCommandOptionNumberChoiceResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandOptionNumberChoiceResponse)

#endif // OAIApplicationCommandOptionNumberChoiceResponse_H
