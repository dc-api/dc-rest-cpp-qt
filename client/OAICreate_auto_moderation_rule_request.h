...
#ifndef OAICreate_auto_moderation_rule_request_H
#define OAICreate_auto_moderation_rule_request_H
...
class OAICreate_auto_moderation_rule_request : public OAIObject {
public:
    OAICreate_auto_moderation_rule_request();
    OAICreate_auto_moderation_rule_request(QString json);
    ~OAICreate_auto_moderation_rule_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreate_auto_moderation_rule_request)

#endif // OAICreate_auto_moderation_rule_request_H
