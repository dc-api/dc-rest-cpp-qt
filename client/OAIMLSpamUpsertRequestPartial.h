...
#ifndef OAIMLSpamUpsertRequestPartial_H
#define OAIMLSpamUpsertRequestPartial_H
...
class OAIMLSpamUpsertRequestPartial : public OAIObject {
public:
    OAIMLSpamUpsertRequestPartial();
    OAIMLSpamUpsertRequestPartial(QString json);
    ~OAIMLSpamUpsertRequestPartial() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMLSpamUpsertRequestPartial)

#endif // OAIMLSpamUpsertRequestPartial_H
