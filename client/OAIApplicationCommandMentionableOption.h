...
#ifndef OAIApplicationCommandMentionableOption_H
#define OAIApplicationCommandMentionableOption_H
...
class OAIApplicationCommandMentionableOption : public OAIObject {
public:
    OAIApplicationCommandMentionableOption();
    OAIApplicationCommandMentionableOption(QString json);
    ~OAIApplicationCommandMentionableOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandMentionableOption)

#endif // OAIApplicationCommandMentionableOption_H
