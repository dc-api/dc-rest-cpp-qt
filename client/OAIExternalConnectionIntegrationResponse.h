...
#ifndef OAIExternalConnectionIntegrationResponse_H
#define OAIExternalConnectionIntegrationResponse_H
...
class OAIExternalConnectionIntegrationResponse : public OAIObject {
public:
    OAIExternalConnectionIntegrationResponse();
    OAIExternalConnectionIntegrationResponse(QString json);
    ~OAIExternalConnectionIntegrationResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIExternalConnectionIntegrationResponse)

#endif // OAIExternalConnectionIntegrationResponse_H
