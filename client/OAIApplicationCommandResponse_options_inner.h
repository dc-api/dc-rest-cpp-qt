...
#ifndef OAIApplicationCommandResponse_options_inner_H
#define OAIApplicationCommandResponse_options_inner_H
...
namespace dc_rest {
class OAIApplicationCommandOptionStringChoiceResponse;
class OAIApplicationCommandSubcommandOptionResponse_options_inner;

class OAIApplicationCommandResponse_options_inner : public OAIObject {
public:
    OAIApplicationCommandResponse_options_inner();
    OAIApplicationCommandResponse_options_inner(QString json);
    ~OAIApplicationCommandResponse_options_inner() override;
    ...
    QList<OAIApplicationCommandOptionStringChoiceResponse> getChoices() const;
    void setChoices(const QList<OAIApplicationCommandOptionStringChoiceResponse> &choices);
    ...
    QList<OAIApplicationCommandSubcommandOptionResponse_options_inner> getOptions() const;
    void setOptions(const QList<OAIApplicationCommandSubcommandOptionResponse_options_inner> &options);
...
private:
    ...
    QList<OAIApplicationCommandOptionStringChoiceResponse> m_choices;
    ...
    QList<OAIApplicationCommandSubcommandOptionResponse_options_inner> m_options;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandResponse_options_inner)

#endif // OAIApplicationCommandResponse_options_inner_H
