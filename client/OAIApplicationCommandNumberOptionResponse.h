...
#ifndef OAIApplicationCommandNumberOptionResponse_H
#define OAIApplicationCommandNumberOptionResponse_H
...
namespace dc_rest {
class OAIApplicationCommandOptionNumberChoiceResponse;

class OAIApplicationCommandNumberOptionResponse : public OAIObject {
public:
    OAIApplicationCommandNumberOptionResponse();
    OAIApplicationCommandNumberOptionResponse(QString json);
    ~OAIApplicationCommandNumberOptionResponse() override;
    ...
    QList<OAIApplicationCommandOptionNumberChoiceResponse> getChoices() const;
    void setChoices(const QList<OAIApplicationCommandOptionNumberChoiceResponse> &choices);
...
private:
    ...
    QList<OAIApplicationCommandOptionNumberChoiceResponse> m_choices;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandNumberOptionResponse)

#endif // OAIApplicationCommandNumberOptionResponse_H
