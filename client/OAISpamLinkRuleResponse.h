...
#ifndef OAISpamLinkRuleResponse_H
#define OAISpamLinkRuleResponse_H
...
class OAISpamLinkRuleResponse : public OAIObject {
public:
    OAISpamLinkRuleResponse();
    OAISpamLinkRuleResponse(QString json);
    ~OAISpamLinkRuleResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAISpamLinkRuleResponse)

#endif // OAISpamLinkRuleResponse_H
