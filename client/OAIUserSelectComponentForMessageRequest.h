...
#ifndef OAIUserSelectComponentForMessageRequest_H
#define OAIUserSelectComponentForMessageRequest_H
...
class OAIUserSelectComponentForMessageRequest : public OAIObject {
public:
    OAIUserSelectComponentForMessageRequest();
    OAIUserSelectComponentForMessageRequest(QString json);
    ~OAIUserSelectComponentForMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUserSelectComponentForMessageRequest)

#endif // OAIUserSelectComponentForMessageRequest_H
