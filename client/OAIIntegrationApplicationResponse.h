...
#ifndef OAIIntegrationApplicationResponse_H
#define OAIIntegrationApplicationResponse_H
...
class OAIIntegrationApplicationResponse : public OAIObject {
public:
    OAIIntegrationApplicationResponse();
    OAIIntegrationApplicationResponse(QString json);
    ~OAIIntegrationApplicationResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIIntegrationApplicationResponse)

#endif // OAIIntegrationApplicationResponse_H
