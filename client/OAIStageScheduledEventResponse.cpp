...
OAIStageScheduledEventResponse::OAIStageScheduledEventResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageScheduledEventResponse::OAIStageScheduledEventResponse() {
    this->initializeModel();
}

OAIStageScheduledEventResponse::~OAIStageScheduledEventResponse() {}

void OAIStageScheduledEventResponse::initializeModel() {
...
void OAIStageScheduledEventResponse::fromJson(QString jsonString) {
...
void OAIStageScheduledEventResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStageScheduledEventResponse::asJson() const {
...
QJsonObject OAIStageScheduledEventResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIStageScheduledEventResponse::getId() const {
    return m_id;
}
void OAIStageScheduledEventResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStageScheduledEventResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStageScheduledEventResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIStageScheduledEventResponse::getGuildId() const {
    return m_guild_id;
}
void OAIStageScheduledEventResponse::setGuildId(const QString &guild_id) {
    m_guild_id = guild_id;
    m_guild_id_isSet = true;
}

bool OAIStageScheduledEventResponse::is_guild_id_Set() const{
    return m_guild_id_isSet;
}

bool OAIStageScheduledEventResponse::is_guild_id_Valid() const{
    return m_guild_id_isValid;
}

QString OAIStageScheduledEventResponse::getName() const {
    return m_name;
}
void OAIStageScheduledEventResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStageScheduledEventResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStageScheduledEventResponse::is_name_Valid() const{
    return m_name_isValid;
}

QDateTime OAIStageScheduledEventResponse::getScheduledStartTime() const {
    return m_scheduled_start_time;
}
void OAIStageScheduledEventResponse::setScheduledStartTime(const QDateTime &scheduled_start_time) {
    m_scheduled_start_time = scheduled_start_time;
    m_scheduled_start_time_isSet = true;
}

bool OAIStageScheduledEventResponse::is_scheduled_start_time_Set() const{
    return m_scheduled_start_time_isSet;
}

bool OAIStageScheduledEventResponse::is_scheduled_start_time_Valid() const{
    return m_scheduled_start_time_isValid;
}

qint32 OAIStageScheduledEventResponse::getStatus() const {
    return m_status;
}
void OAIStageScheduledEventResponse::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStageScheduledEventResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStageScheduledEventResponse::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIStageScheduledEventResponse::getEntityType() const {
    return m_entity_type;
}
void OAIStageScheduledEventResponse::setEntityType(const qint32 &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIStageScheduledEventResponse::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIStageScheduledEventResponse::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QJsonValue OAIStageScheduledEventResponse::getPrivacyLevel() const {
    return m_privacy_level;
}
void OAIStageScheduledEventResponse::setPrivacyLevel(const QJsonValue &privacy_level) {
    m_privacy_level = privacy_level;
    m_privacy_level_isSet = true;
}

bool OAIStageScheduledEventResponse::is_privacy_level_Set() const{
    return m_privacy_level_isSet;
}

bool OAIStageScheduledEventResponse::is_privacy_level_Valid() const{
    return m_privacy_level_isValid;
}

QString OAIStageScheduledEventResponse::getDescription() const {
    return m_description;
}
void OAIStageScheduledEventResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIStageScheduledEventResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIStageScheduledEventResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIStageScheduledEventResponse::getChannelId() const {
    return m_channel_id;
}
void OAIStageScheduledEventResponse::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAIStageScheduledEventResponse::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAIStageScheduledEventResponse::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

QString OAIStageScheduledEventResponse::getCreatorId() const {
    return m_creator_id;
}
void OAIStageScheduledEventResponse::setCreatorId(const QString &creator_id) {
    m_creator_id = creator_id;
    m_creator_id_isSet = true;
}

bool OAIStageScheduledEventResponse::is_creator_id_Set() const{
    return m_creator_id_isSet;
}

bool OAIStageScheduledEventResponse::is_creator_id_Valid() const{
    return m_creator_id_isValid;
}

OAIUserResponse OAIStageScheduledEventResponse::getCreator() const {
    return m_creator;
}
void OAIStageScheduledEventResponse::setCreator(const OAIUserResponse &creator) {
    m_creator = creator;
    m_creator_isSet = true;
}

bool OAIStageScheduledEventResponse::is_creator_Set() const{
    return m_creator_isSet;
}

bool OAIStageScheduledEventResponse::is_creator_Valid() const{
    return m_creator_isValid;
}

QString OAIStageScheduledEventResponse::getImage() const {
    return m_image;
}
void OAIStageScheduledEventResponse::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIStageScheduledEventResponse::is_image_Set() const{
    return m_image_isSet;
}

bool OAIStageScheduledEventResponse::is_image_Valid() const{
    return m_image_isValid;
}

QDateTime OAIStageScheduledEventResponse::getScheduledEndTime() const {
    return m_scheduled_end_time;
}
void OAIStageScheduledEventResponse::setScheduledEndTime(const QDateTime &scheduled_end_time) {
    m_scheduled_end_time = scheduled_end_time;
    m_scheduled_end_time_isSet = true;
}

bool OAIStageScheduledEventResponse::is_scheduled_end_time_Set() const{
    return m_scheduled_end_time_isSet;
}

bool OAIStageScheduledEventResponse::is_scheduled_end_time_Valid() const{
    return m_scheduled_end_time_isValid;
}

QString OAIStageScheduledEventResponse::getEntityId() const {
    return m_entity_id;
}
void OAIStageScheduledEventResponse::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIStageScheduledEventResponse::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIStageScheduledEventResponse::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

qint32 OAIStageScheduledEventResponse::getUserCount() const {
    return m_user_count;
}
void OAIStageScheduledEventResponse::setUserCount(const qint32 &user_count) {
    m_user_count = user_count;
    m_user_count_isSet = true;
}

bool OAIStageScheduledEventResponse::is_user_count_Set() const{
    return m_user_count_isSet;
}

bool OAIStageScheduledEventResponse::is_user_count_Valid() const{
    return m_user_count_isValid;
}

OAIScheduledEventUserResponse OAIStageScheduledEventResponse::getUserRsvp() const {
    return m_user_rsvp;
}
void OAIStageScheduledEventResponse::setUserRsvp(const OAIScheduledEventUserResponse &user_rsvp) {
    m_user_rsvp = user_rsvp;
    m_user_rsvp_isSet = true;
}

bool OAIStageScheduledEventResponse::is_user_rsvp_Set() const{
    return m_user_rsvp_isSet;
}

bool OAIStageScheduledEventResponse::is_user_rsvp_Valid() const{
    return m_user_rsvp_isValid;
}

OAIObject OAIStageScheduledEventResponse::getEntityMetadata() const {
    return m_entity_metadata;
}
void OAIStageScheduledEventResponse::setEntityMetadata(const OAIObject &entity_metadata) {
    m_entity_metadata = entity_metadata;
    m_entity_metadata_isSet = true;
}

bool OAIStageScheduledEventResponse::is_entity_metadata_Set() const{
    return m_entity_metadata_isSet;
}

bool OAIStageScheduledEventResponse::is_entity_metadata_Valid() const{
    return m_entity_metadata_isValid;
}

bool OAIStageScheduledEventResponse::isSet() const {
...
bool OAIStageScheduledEventResponse::isValid() const {
