...
#ifndef OAIUpdate_channel_request_H
#define OAIUpdate_channel_request_H
...
class OAIUpdate_channel_request : public OAIObject {
public:
    OAIUpdate_channel_request();
    OAIUpdate_channel_request(QString json);
    ~OAIUpdate_channel_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUpdate_channel_request)

#endif // OAIUpdate_channel_request_H
