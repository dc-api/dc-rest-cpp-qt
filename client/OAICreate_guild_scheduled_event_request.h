...
#ifndef OAICreate_guild_scheduled_event_request_H
#define OAICreate_guild_scheduled_event_request_H
...
class OAICreate_guild_scheduled_event_request : public OAIObject {
public:
    OAICreate_guild_scheduled_event_request();
    OAICreate_guild_scheduled_event_request(QString json);
    ~OAICreate_guild_scheduled_event_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreate_guild_scheduled_event_request)

#endif // OAICreate_guild_scheduled_event_request_H
