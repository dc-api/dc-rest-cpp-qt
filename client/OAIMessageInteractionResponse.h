...
#ifndef OAIMessageInteractionResponse_H
#define OAIMessageInteractionResponse_H
...
class OAIMessageInteractionResponse : public OAIObject {
public:
    OAIMessageInteractionResponse();
    OAIMessageInteractionResponse(QString json);
    ~OAIMessageInteractionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageInteractionResponse)

#endif // OAIMessageInteractionResponse_H
