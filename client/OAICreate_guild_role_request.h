...
#ifndef OAICreate_guild_role_request_H
#define OAICreate_guild_role_request_H
...
class OAICreate_guild_role_request : public OAIObject {
public:
    OAICreate_guild_role_request();
    OAICreate_guild_role_request(QString json);
    ~OAICreate_guild_role_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreate_guild_role_request)

#endif // OAICreate_guild_role_request_H
