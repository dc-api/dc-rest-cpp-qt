...
#ifndef OAIApplicationCommandNumberOption_H
#define OAIApplicationCommandNumberOption_H
...
class OAIApplicationCommandNumberOption : public OAIObject {
public:
    OAIApplicationCommandNumberOption();
    OAIApplicationCommandNumberOption(QString json);
    ~OAIApplicationCommandNumberOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandNumberOption)

#endif // OAIApplicationCommandNumberOption_H
