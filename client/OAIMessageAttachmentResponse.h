...
#ifndef OAIMessageAttachmentResponse_H
#define OAIMessageAttachmentResponse_H
...
class OAIMessageAttachmentResponse : public OAIObject {
public:
    OAIMessageAttachmentResponse();
    OAIMessageAttachmentResponse(QString json);
    ~OAIMessageAttachmentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageAttachmentResponse)

#endif // OAIMessageAttachmentResponse_H
