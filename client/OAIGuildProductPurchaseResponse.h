...
#ifndef OAIGuildProductPurchaseResponse_H
#define OAIGuildProductPurchaseResponse_H
...
class OAIGuildProductPurchaseResponse : public OAIObject {
public:
    OAIGuildProductPurchaseResponse();
    OAIGuildProductPurchaseResponse(QString json);
    ~OAIGuildProductPurchaseResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildProductPurchaseResponse)

#endif // OAIGuildProductPurchaseResponse_H
