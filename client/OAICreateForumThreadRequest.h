...
#ifndef OAICreateForumThreadRequest_H
#define OAICreateForumThreadRequest_H
...
namespace dc_rest {
class OAIBaseCreateMessageCreateRequest;

class OAICreateForumThreadRequest : public OAIObject {
public:
    OAICreateForumThreadRequest();
    OAICreateForumThreadRequest(QString json);
    ~OAICreateForumThreadRequest() override;
    ...
    OAIBaseCreateMessageCreateRequest getMessage() const;
    void setMessage(const OAIBaseCreateMessageCreateRequest &message);
...
private:
    ...
    OAIBaseCreateMessageCreateRequest m_message;
...
Q_DECLARE_METATYPE(dc_rest::OAICreateForumThreadRequest)

#endif // OAICreateForumThreadRequest_H
