...
#ifndef OAIApplicationCommandRoleOptionResponse_H
#define OAIApplicationCommandRoleOptionResponse_H
...
class OAIApplicationCommandRoleOptionResponse : public OAIObject {
public:
    OAIApplicationCommandRoleOptionResponse();
    OAIApplicationCommandRoleOptionResponse(QString json);
    ~OAIApplicationCommandRoleOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandRoleOptionResponse)

#endif // OAIApplicationCommandRoleOptionResponse_H
