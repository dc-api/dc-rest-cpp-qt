...
#ifndef OAIGroupDMInviteResponse_H
#define OAIGroupDMInviteResponse_H
...
class OAIGroupDMInviteResponse : public OAIObject {
public:
    OAIGroupDMInviteResponse();
    OAIGroupDMInviteResponse(QString json);
    ~OAIGroupDMInviteResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGroupDMInviteResponse)

#endif // OAIGroupDMInviteResponse_H
