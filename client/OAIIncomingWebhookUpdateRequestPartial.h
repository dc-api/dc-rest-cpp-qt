...
#ifndef OAIIncomingWebhookUpdateRequestPartial_H
#define OAIIncomingWebhookUpdateRequestPartial_H
...
class OAIIncomingWebhookUpdateRequestPartial : public OAIObject {
public:
    OAIIncomingWebhookUpdateRequestPartial();
    OAIIncomingWebhookUpdateRequestPartial(QString json);
    ~OAIIncomingWebhookUpdateRequestPartial() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIIncomingWebhookUpdateRequestPartial)

#endif // OAIIncomingWebhookUpdateRequestPartial_H
