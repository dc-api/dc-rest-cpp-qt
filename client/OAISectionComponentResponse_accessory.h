...
#ifndef OAISectionComponentResponse_accessory_H
#define OAISectionComponentResponse_accessory_H
...
class OAISectionComponentResponse_accessory : public OAIObject {
public:
    OAISectionComponentResponse_accessory();
    OAISectionComponentResponse_accessory(QString json);
    ~OAISectionComponentResponse_accessory() override;
    ...
    OAIUnfurledMediaResponse getMedia() const;
    void setMedia(const OAIUnfurledMediaResponse &media);
...
private:
    ...
    OAIUnfurledMediaResponse m_media;
    bool m_media_isSet;
...
Q_DECLARE_METATYPE(dc_rest::OAISectionComponentResponse_accessory)

#endif // OAISectionComponentResponse_accessory_H
