...
#ifndef OAIMessageCallResponse_H
#define OAIMessageCallResponse_H
...
class OAIMessageCallResponse : public OAIObject {
public:
    OAIMessageCallResponse();
    OAIMessageCallResponse(QString json);
    ~OAIMessageCallResponse() override;
    ...
    QSet<QString> getParticipants() const;
...
Q_DECLARE_METATYPE(dc_rest::OAIMessageCallResponse)

#endif // OAIMessageCallResponse_H
