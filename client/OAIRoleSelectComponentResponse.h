...
#ifndef OAIRoleSelectComponentResponse_H
#define OAIRoleSelectComponentResponse_H
...
namespace dc_rest {
class OAIRoleSelectDefaultValueResponse;

class OAIRoleSelectComponentResponse : public OAIObject {
public:
    OAIRoleSelectComponentResponse();
    OAIRoleSelectComponentResponse(QString json);
    ~OAIRoleSelectComponentResponse() override;
    ...
    QList<OAIRoleSelectDefaultValueResponse> getDefaultValues() const;
    void setDefaultValues(const QList<OAIRoleSelectDefaultValueResponse> &default_values);
...
private:
    ...
    QList<OAIRoleSelectDefaultValueResponse> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIRoleSelectComponentResponse)

#endif // OAIRoleSelectComponentResponse_H
