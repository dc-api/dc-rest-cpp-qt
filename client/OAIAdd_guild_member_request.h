...
#ifndef OAIAdd_guild_member_request_H
#define OAIAdd_guild_member_request_H
...
class OAIAdd_guild_member_request : public OAIObject {
public:
    OAIAdd_guild_member_request();
    OAIAdd_guild_member_request(QString json);
    ~OAIAdd_guild_member_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIAdd_guild_member_request)

#endif // OAIAdd_guild_member_request_H
