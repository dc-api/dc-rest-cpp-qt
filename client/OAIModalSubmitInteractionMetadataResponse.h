...
#ifndef OAIModalSubmitInteractionMetadataResponse_H
#define OAIModalSubmitInteractionMetadataResponse_H
...
class OAIModalSubmitInteractionMetadataResponse : public OAIObject {
public:
    OAIModalSubmitInteractionMetadataResponse();
    OAIModalSubmitInteractionMetadataResponse(QString json);
    ~OAIModalSubmitInteractionMetadataResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIModalSubmitInteractionMetadataResponse)

#endif // OAIModalSubmitInteractionMetadataResponse_H
