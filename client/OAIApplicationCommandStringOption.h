...
#ifndef OAIApplicationCommandStringOption_H
#define OAIApplicationCommandStringOption_H
...
class OAIApplicationCommandStringOption : public OAIObject {
public:
    OAIApplicationCommandStringOption();
    OAIApplicationCommandStringOption(QString json);
    ~OAIApplicationCommandStringOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandStringOption)

#endif // OAIApplicationCommandStringOption_H
