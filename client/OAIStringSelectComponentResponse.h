...
#ifndef OAIStringSelectComponentResponse_H
#define OAIStringSelectComponentResponse_H
...
class OAIStringSelectComponentResponse : public OAIObject {
public:
    OAIStringSelectComponentResponse();
    OAIStringSelectComponentResponse(QString json);
    ~OAIStringSelectComponentResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIStringSelectComponentResponse)

#endif // OAIStringSelectComponentResponse_H
