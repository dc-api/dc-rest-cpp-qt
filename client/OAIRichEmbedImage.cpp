...
OAIRichEmbedImage::OAIRichEmbedImage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRichEmbedImage::OAIRichEmbedImage() {
    this->initializeModel();
}

OAIRichEmbedImage::~OAIRichEmbedImage() {}

void OAIRichEmbedImage::initializeModel() {
...
void OAIRichEmbedImage::fromJson(QString jsonString) {
...
void OAIRichEmbedImage::fromJsonObject(QJsonObject json) {
...
QString OAIRichEmbedImage::asJson() const {
...
QJsonObject OAIRichEmbedImage::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAIRichEmbedImage::getUrl() const {
    return m_url;
}
void OAIRichEmbedImage::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIRichEmbedImage::is_url_Set() const{
    return m_url_isSet;
}

bool OAIRichEmbedImage::is_url_Valid() const{
    return m_url_isValid;
}

qint32 OAIRichEmbedImage::getWidth() const {
    return m_width;
}
void OAIRichEmbedImage::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIRichEmbedImage::is_width_Set() const{
    return m_width_isSet;
}

bool OAIRichEmbedImage::is_width_Valid() const{
    return m_width_isValid;
}

qint32 OAIRichEmbedImage::getHeight() const {
    return m_height;
}
void OAIRichEmbedImage::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIRichEmbedImage::is_height_Set() const{
    return m_height_isSet;
}

bool OAIRichEmbedImage::is_height_Valid() const{
    return m_height_isValid;
}

QString OAIRichEmbedImage::getPlaceholder() const {
    return m_placeholder;
}
void OAIRichEmbedImage::setPlaceholder(const QString &placeholder) {
    m_placeholder = placeholder;
    m_placeholder_isSet = true;
}

bool OAIRichEmbedImage::is_placeholder_Set() const{
    return m_placeholder_isSet;
}

bool OAIRichEmbedImage::is_placeholder_Valid() const{
    return m_placeholder_isValid;
}

qint32 OAIRichEmbedImage::getPlaceholderVersion() const {
    return m_placeholder_version;
}
void OAIRichEmbedImage::setPlaceholderVersion(const qint32 &placeholder_version) {
    m_placeholder_version = placeholder_version;
    m_placeholder_version_isSet = true;
}

bool OAIRichEmbedImage::is_placeholder_version_Set() const{
    return m_placeholder_version_isSet;
}

bool OAIRichEmbedImage::is_placeholder_version_Valid() const{
    return m_placeholder_version_isValid;
}

bool OAIRichEmbedImage::isIsAnimated() const {
    return m_is_animated;
}
void OAIRichEmbedImage::setIsAnimated(const bool &is_animated) {
    m_is_animated = is_animated;
    m_is_animated_isSet = true;
}

bool OAIRichEmbedImage::is_is_animated_Set() const{
    return m_is_animated_isSet;
}

bool OAIRichEmbedImage::is_is_animated_Valid() const{
    return m_is_animated_isValid;
}

QString OAIRichEmbedImage::getDescription() const {
    return m_description;
}
void OAIRichEmbedImage::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRichEmbedImage::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRichEmbedImage::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIRichEmbedImage::isSet() const {
...
bool OAIRichEmbedImage::isValid() const {
