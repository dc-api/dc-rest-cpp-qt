...
#ifndef OAIThreadMetadataResponse_H
#define OAIThreadMetadataResponse_H
...
class OAIThreadMetadataResponse : public OAIObject {
public:
    OAIThreadMetadataResponse();
    OAIThreadMetadataResponse(QString json);
    ~OAIThreadMetadataResponse() override;
    ...
    QDateTime getArchiveTimestamp() const;
    void setArchiveTimestamp(const QDateTime &archive_timestamp);
    bool is_archive_timestamp_Set() const;
    bool is_archive_timestamp_Valid() const;
...
private:
    ...
    QDateTime m_archive_timestamp;
    bool m_archive_timestamp_isSet;
    bool m_archive_timestamp_isValid;
...
Q_DECLARE_METATYPE(dc_rest::OAIThreadMetadataResponse)

#endif // OAIThreadMetadataResponse_H
