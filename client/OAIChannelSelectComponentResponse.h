...
#ifndef OAIChannelSelectComponentResponse_H
#define OAIChannelSelectComponentResponse_H
...
namespace dc_rest {
class OAIChannelSelectDefaultValueResponse;

class OAIChannelSelectComponentResponse : public OAIObject {
public:
    OAIChannelSelectComponentResponse();
    OAIChannelSelectComponentResponse(QString json);
    ~OAIChannelSelectComponentResponse() override;
    ...
    QList<OAIChannelSelectDefaultValueResponse> getDefaultValues() const;
    void setDefaultValues(const QList<OAIChannelSelectDefaultValueResponse> &default_values);
...
private:
    ...
    QList<OAIChannelSelectDefaultValueResponse> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIChannelSelectComponentResponse)

#endif // OAIChannelSelectComponentResponse_H
