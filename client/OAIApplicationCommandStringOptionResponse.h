...
#ifndef OAIApplicationCommandStringOptionResponse_H
#define OAIApplicationCommandStringOptionResponse_H
...
class OAIApplicationCommandStringOptionResponse : public OAIObject {
public:
    OAIApplicationCommandStringOptionResponse();
    OAIApplicationCommandStringOptionResponse(QString json);
    ~OAIApplicationCommandStringOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandStringOptionResponse)

#endif // OAIApplicationCommandStringOptionResponse_H
