...
#ifndef OAICreateGuildChannelRequest_H
#define OAICreateGuildChannelRequest_H
...
class OAICreateGuildChannelRequest : public OAIObject {
public:
    OAICreateGuildChannelRequest();
    OAICreateGuildChannelRequest(QString json);
    ~OAICreateGuildChannelRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreateGuildChannelRequest)

#endif // OAICreateGuildChannelRequest_H
