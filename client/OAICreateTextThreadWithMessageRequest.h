...
#ifndef OAICreateTextThreadWithMessageRequest_H
#define OAICreateTextThreadWithMessageRequest_H
...
class OAICreateTextThreadWithMessageRequest : public OAIObject {
public:
    OAICreateTextThreadWithMessageRequest();
    OAICreateTextThreadWithMessageRequest(QString json);
    ~OAICreateTextThreadWithMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAICreateTextThreadWithMessageRequest)

#endif // OAICreateTextThreadWithMessageRequest_H
