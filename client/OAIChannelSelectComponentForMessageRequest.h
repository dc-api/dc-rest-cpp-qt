...
#ifndef OAIChannelSelectComponentForMessageRequest_H
#define OAIChannelSelectComponentForMessageRequest_H
...
namespace dc_rest {
class OAIChannelSelectDefaultValue;

class OAIChannelSelectComponentForMessageRequest : public OAIObject {
public:
    OAIChannelSelectComponentForMessageRequest();
    OAIChannelSelectComponentForMessageRequest(QString json);
    ~OAIChannelSelectComponentForMessageRequest() override;
    ...
    QList<OAIChannelSelectDefaultValue> getDefaultValues() const;
    void setDefaultValues(const QList<OAIChannelSelectDefaultValue> &default_values);
...
private:
    ...
    QList<OAIChannelSelectDefaultValue> m_default_values;
...
Q_DECLARE_METATYPE(dc_rest::OAIChannelSelectComponentForMessageRequest)

#endif // OAIChannelSelectComponentForMessageRequest_H
