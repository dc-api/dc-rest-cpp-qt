...
#ifndef OAIApplicationCommandAttachmentOption_H
#define OAIApplicationCommandAttachmentOption_H
...
class OAIApplicationCommandAttachmentOption : public OAIObject {
public:
    OAIApplicationCommandAttachmentOption();
    OAIApplicationCommandAttachmentOption(QString json);
    ~OAIApplicationCommandAttachmentOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandAttachmentOption)

#endif // OAIApplicationCommandAttachmentOption_H
