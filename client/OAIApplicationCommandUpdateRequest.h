...
#ifndef OAIApplicationCommandUpdateRequest_H
#define OAIApplicationCommandUpdateRequest_H
...
class OAIApplicationCommandUpdateRequest : public OAIObject {
public:
    OAIApplicationCommandUpdateRequest();
    OAIApplicationCommandUpdateRequest(QString json);
    ~OAIApplicationCommandUpdateRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandUpdateRequest)

#endif // OAIApplicationCommandUpdateRequest_H
