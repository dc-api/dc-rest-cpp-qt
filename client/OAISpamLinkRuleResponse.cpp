...
#include "OAISpamLinkRuleResponse.h"
...
OAISpamLinkRuleResponse::OAISpamLinkRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISpamLinkRuleResponse::OAISpamLinkRuleResponse() {
    this->initializeModel();
}

OAISpamLinkRuleResponse::~OAISpamLinkRuleResponse() {}

void OAISpamLinkRuleResponse::initializeModel() {
...
void OAISpamLinkRuleResponse::fromJson(QString jsonString) {
...
void OAISpamLinkRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAISpamLinkRuleResponse::asJson() const {
...
QJsonObject OAISpamLinkRuleResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAISpamLinkRuleResponse::getId() const {
    return m_id;
}
void OAISpamLinkRuleResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISpamLinkRuleResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAISpamLinkRuleResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISpamLinkRuleResponse::getGuildId() const {
    return m_guild_id;
}
void OAISpamLinkRuleResponse::setGuildId(const QString &guild_id) {
    m_guild_id = guild_id;
    m_guild_id_isSet = true;
}

bool OAISpamLinkRuleResponse::is_guild_id_Set() const{
    return m_guild_id_isSet;
}

bool OAISpamLinkRuleResponse::is_guild_id_Valid() const{
    return m_guild_id_isValid;
}

QString OAISpamLinkRuleResponse::getCreatorId() const {
    return m_creator_id;
}
void OAISpamLinkRuleResponse::setCreatorId(const QString &creator_id) {
    m_creator_id = creator_id;
    m_creator_id_isSet = true;
}

bool OAISpamLinkRuleResponse::is_creator_id_Set() const{
    return m_creator_id_isSet;
}

bool OAISpamLinkRuleResponse::is_creator_id_Valid() const{
    return m_creator_id_isValid;
}

QString OAISpamLinkRuleResponse::getName() const {
    return m_name;
}
void OAISpamLinkRuleResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISpamLinkRuleResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAISpamLinkRuleResponse::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAISpamLinkRuleResponse::getEventType() const {
    return m_event_type;
}
void OAISpamLinkRuleResponse::setEventType(const qint32 &event_type) {
    m_event_type = event_type;
    m_event_type_isSet = true;
}

bool OAISpamLinkRuleResponse::is_event_type_Set() const{
    return m_event_type_isSet;
}

bool OAISpamLinkRuleResponse::is_event_type_Valid() const{
    return m_event_type_isValid;
}

QList<OAIDefaultKeywordRuleResponse_actions_inner> OAISpamLinkRuleResponse::getActions() const {
    return m_actions;
}
void OAISpamLinkRuleResponse::setActions(const QList<OAIDefaultKeywordRuleResponse_actions_inner> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAISpamLinkRuleResponse::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAISpamLinkRuleResponse::is_actions_Valid() const{
    return m_actions_isValid;
}

qint32 OAISpamLinkRuleResponse::getTriggerType() const {
    return m_trigger_type;
}
void OAISpamLinkRuleResponse::setTriggerType(const qint32 &trigger_type) {
    m_trigger_type = trigger_type;
    m_trigger_type_isSet = true;
}

bool OAISpamLinkRuleResponse::is_trigger_type_Set() const{
    return m_trigger_type_isSet;
}

bool OAISpamLinkRuleResponse::is_trigger_type_Valid() const{
    return m_trigger_type_isValid;
}

OAIObject OAISpamLinkRuleResponse::getTriggerMetadata() const {
    return m_trigger_metadata;
}
void OAISpamLinkRuleResponse::setTriggerMetadata(const OAIObject &trigger_metadata) {
    m_trigger_metadata = trigger_metadata;
    m_trigger_metadata_isSet = true;
}

bool OAISpamLinkRuleResponse::is_trigger_metadata_Set() const{
    return m_trigger_metadata_isSet;
}

bool OAISpamLinkRuleResponse::is_trigger_metadata_Valid() const{
    return m_trigger_metadata_isValid;
}

bool OAISpamLinkRuleResponse::isEnabled() const {
    return m_enabled;
}
void OAISpamLinkRuleResponse::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISpamLinkRuleResponse::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISpamLinkRuleResponse::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QSet<QString> OAISpamLinkRuleResponse::getExemptRoles() const {
    return m_exempt_roles;
}
void OAISpamLinkRuleResponse::setExemptRoles(const QSet<QString> &exempt_roles) {
    m_exempt_roles = exempt_roles;
    m_exempt_roles_isSet = true;
}

bool OAISpamLinkRuleResponse::is_exempt_roles_Set() const{
    return m_exempt_roles_isSet;
}

bool OAISpamLinkRuleResponse::is_exempt_roles_Valid() const{
    return m_exempt_roles_isValid;
}

QSet<QString> OAISpamLinkRuleResponse::getExemptChannels() const {
    return m_exempt_channels;
}
void OAISpamLinkRuleResponse::setExemptChannels(const QSet<QString> &exempt_channels) {
    m_exempt_channels = exempt_channels;
    m_exempt_channels_isSet = true;
}

bool OAISpamLinkRuleResponse::is_exempt_channels_Set() const{
    return m_exempt_channels_isSet;
}

bool OAISpamLinkRuleResponse::is_exempt_channels_Valid() const{
    return m_exempt_channels_isValid;
}

bool OAISpamLinkRuleResponse::isSet() const {
...
bool OAISpamLinkRuleResponse::isValid() const {
