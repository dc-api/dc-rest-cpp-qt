...
#ifndef OAIFileComponentForMessageRequest_H
#define OAIFileComponentForMessageRequest_H
...
class OAIFileComponentForMessageRequest : public OAIObject {
public:
    OAIFileComponentForMessageRequest();
    OAIFileComponentForMessageRequest(QString json);
    ~OAIFileComponentForMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIFileComponentForMessageRequest)

#endif // OAIFileComponentForMessageRequest_H
