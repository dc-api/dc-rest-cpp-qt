...
#ifndef OAIMLSpamRuleResponse_H
#define OAIMLSpamRuleResponse_H
...
class OAIMLSpamRuleResponse : public OAIObject {
public:
    OAIMLSpamRuleResponse();
    OAIMLSpamRuleResponse(QString json);
    ~OAIMLSpamRuleResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIMLSpamRuleResponse)

#endif // OAIMLSpamRuleResponse_H
