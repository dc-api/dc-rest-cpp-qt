...
#ifndef OAIApplicationRoleConnectionsMetadataItemResponse_H
#define OAIApplicationRoleConnectionsMetadataItemResponse_H
...
class OAIApplicationRoleConnectionsMetadataItemResponse : public OAIObject {
public:
    OAIApplicationRoleConnectionsMetadataItemResponse();
    OAIApplicationRoleConnectionsMetadataItemResponse(QString json);
    ~OAIApplicationRoleConnectionsMetadataItemResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationRoleConnectionsMetadataItemResponse)

#endif // OAIApplicationRoleConnectionsMetadataItemResponse_H
