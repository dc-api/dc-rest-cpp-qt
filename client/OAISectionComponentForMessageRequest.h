...
#ifndef OAISectionComponentForMessageRequest_H
#define OAISectionComponentForMessageRequest_H
...
class OAISectionComponentForMessageRequest : public OAIObject {
public:
    OAISectionComponentForMessageRequest();
    OAISectionComponentForMessageRequest(QString json);
    ~OAISectionComponentForMessageRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAISectionComponentForMessageRequest)

#endif // OAISectionComponentForMessageRequest_H
