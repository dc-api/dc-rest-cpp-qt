...
#ifndef OAIGuildTemplateRoleResponse_H
#define OAIGuildTemplateRoleResponse_H
...
class OAIGuildTemplateRoleResponse : public OAIObject {
public:
    OAIGuildTemplateRoleResponse();
    OAIGuildTemplateRoleResponse(QString json);
    ~OAIGuildTemplateRoleResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildTemplateRoleResponse)

#endif // OAIGuildTemplateRoleResponse_H
