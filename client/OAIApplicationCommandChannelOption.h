...
#ifndef OAIApplicationCommandChannelOption_H
#define OAIApplicationCommandChannelOption_H
...
class OAIApplicationCommandChannelOption : public OAIObject {
public:
    OAIApplicationCommandChannelOption();
    OAIApplicationCommandChannelOption(QString json);
    ~OAIApplicationCommandChannelOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandChannelOption)

#endif // OAIApplicationCommandChannelOption_H
