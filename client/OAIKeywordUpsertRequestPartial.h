...
#ifndef OAIKeywordUpsertRequestPartial_H
#define OAIKeywordUpsertRequestPartial_H
...
class OAIKeywordTriggerMetadata;

class OAIKeywordUpsertRequestPartial : public OAIObject {
public:
    OAIKeywordUpsertRequestPartial();
    OAIKeywordUpsertRequestPartial(QString json);
    ~OAIKeywordUpsertRequestPartial() override;
    ...
    OAIKeywordTriggerMetadata getTriggerMetadata() const;
    void setTriggerMetadata(const OAIKeywordTriggerMetadata &trigger_metadata);
...
private:
    ...
    OAIKeywordTriggerMetadata m_trigger_metadata;
...
Q_DECLARE_METATYPE(dc_rest::OAIKeywordUpsertRequestPartial)

#endif // OAIKeywordUpsertRequestPartial_H
