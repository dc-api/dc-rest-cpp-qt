...
public:
    ...
    QList<OAITeamMemberResponse> getMembers() const;
    void setMembers(const QList<OAITeamMemberResponse> &members);
...
private:
    ...
    QList<OAITeamMemberResponse> m_members;
...
Q_DECLARE_METATYPE(dc_rest::OAITeamResponse)
