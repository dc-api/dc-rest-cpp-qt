...
#ifndef OAIApplicationCommandMentionableOptionResponse_H
#define OAIApplicationCommandMentionableOptionResponse_H
...
class OAIApplicationCommandMentionableOptionResponse : public OAIObject {
public:
    OAIApplicationCommandMentionableOptionResponse();
    OAIApplicationCommandMentionableOptionResponse(QString json);
    ~OAIApplicationCommandMentionableOptionResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandMentionableOptionResponse)

#endif // OAIApplicationCommandMentionableOptionResponse_H
