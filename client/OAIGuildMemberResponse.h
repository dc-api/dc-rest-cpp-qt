...
#ifndef OAIGuildMemberResponse_H
#define OAIGuildMemberResponse_H
...
class OAIGuildMemberResponse : public OAIObject {
public:
    OAIGuildMemberResponse();
    OAIGuildMemberResponse(QString json);
    ~OAIGuildMemberResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGuildMemberResponse)

#endif // OAIGuildMemberResponse_H
