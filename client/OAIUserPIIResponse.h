...
#ifndef OAIUserPIIResponse_H
#define OAIUserPIIResponse_H
...
class OAIUserPIIResponse : public OAIObject {
public:
    OAIUserPIIResponse();
    OAIUserPIIResponse(QString json);
    ~OAIUserPIIResponse() override;
    ...
    void setMfaEnabled(const bool &mfa_enabled);
    bool is_mfa_enabled_Set() const;
    bool is_mfa_enabled_Valid() const;
    ...
    qint32 getPremiumType() const;
    void setPremiumType(const qint32 &premium_type);
    bool is_premium_type_Set() const;
    bool is_premium_type_Valid() const;
...
private:
    ...
    bool m_mfa_enabled;
    bool m_mfa_enabled_isSet;
    bool m_mfa_enabled_isValid;
    ...
    qint32 m_premium_type;
    bool m_premium_type_isSet;
    bool m_premium_type_isValid;
...
Q_DECLARE_METATYPE(dc_rest::OAIUserPIIResponse)

#endif // OAIUserPIIResponse_H
