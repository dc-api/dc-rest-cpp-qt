...
#ifndef OAIInviteApplicationResponse_H
#define OAIInviteApplicationResponse_H
...
class OAIInviteApplicationResponse : public OAIObject {
public:
    OAIInviteApplicationResponse();
    OAIInviteApplicationResponse(QString json);
    ~OAIInviteApplicationResponse() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIInviteApplicationResponse)

#endif // OAIInviteApplicationResponse_H
