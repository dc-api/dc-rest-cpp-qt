...
#ifndef OAIApplicationCommandSubcommandGroupOption_H
#define OAIApplicationCommandSubcommandGroupOption_H
...
namespace dc_rest {
class OAIApplicationCommandSubcommandOption;

class OAIApplicationCommandSubcommandGroupOption : public OAIObject {
public:
    OAIApplicationCommandSubcommandGroupOption();
    OAIApplicationCommandSubcommandGroupOption(QString json);
    ~OAIApplicationCommandSubcommandGroupOption() override;
    ...
    QList<OAIApplicationCommandSubcommandOption> getOptions() const;
    void setOptions(const QList<OAIApplicationCommandSubcommandOption> &options);
...
private:
    ...
    QList<OAIApplicationCommandSubcommandOption> m_options;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandSubcommandGroupOption)

#endif // OAIApplicationCommandSubcommandGroupOption_H
