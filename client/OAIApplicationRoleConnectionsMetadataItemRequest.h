...
#ifndef OAIApplicationRoleConnectionsMetadataItemRequest_H
#define OAIApplicationRoleConnectionsMetadataItemRequest_H
...
class OAIApplicationRoleConnectionsMetadataItemRequest : public OAIObject {
public:
    OAIApplicationRoleConnectionsMetadataItemRequest();
    OAIApplicationRoleConnectionsMetadataItemRequest(QString json);
    ~OAIApplicationRoleConnectionsMetadataItemRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationRoleConnectionsMetadataItemRequest)

#endif // OAIApplicationRoleConnectionsMetadataItemRequest_H
