...
#ifndef OAIApplicationCommandRoleOption_H
#define OAIApplicationCommandRoleOption_H
...
class OAIApplicationCommandRoleOption : public OAIObject {
public:
    OAIApplicationCommandRoleOption();
    OAIApplicationCommandRoleOption(QString json);
    ~OAIApplicationCommandRoleOption() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIApplicationCommandRoleOption)

#endif // OAIApplicationCommandRoleOption_H
