...
#include "OAIUpdateGuildChannelRequestPartial.h"
...
OAIUpdateGuildChannelRequestPartial::OAIUpdateGuildChannelRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGuildChannelRequestPartial::OAIUpdateGuildChannelRequestPartial() {
    this->initializeModel();
}

OAIUpdateGuildChannelRequestPartial::~OAIUpdateGuildChannelRequestPartial() {}

void OAIUpdateGuildChannelRequestPartial::initializeModel() {
...
void OAIUpdateGuildChannelRequestPartial::fromJson(QString jsonString) {
...
void OAIUpdateGuildChannelRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGuildChannelRequestPartial::asJson() const {
...
QJsonObject OAIUpdateGuildChannelRequestPartial::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
qint32 OAIUpdateGuildChannelRequestPartial::getType() const {
    return m_type;
}
void OAIUpdateGuildChannelRequestPartial::setType(const qint32 &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIUpdateGuildChannelRequestPartial::getName() const {
    return m_name;
}
void OAIUpdateGuildChannelRequestPartial::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getPosition() const {
    return m_position;
}
void OAIUpdateGuildChannelRequestPartial::setPosition(const qint32 &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_position_Set() const{
    return m_position_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_position_Valid() const{
    return m_position_isValid;
}

QString OAIUpdateGuildChannelRequestPartial::getTopic() const {
    return m_topic;
}
void OAIUpdateGuildChannelRequestPartial::setTopic(const QString &topic) {
    m_topic = topic;
    m_topic_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_topic_Set() const{
    return m_topic_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_topic_Valid() const{
    return m_topic_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getBitrate() const {
    return m_bitrate;
}
void OAIUpdateGuildChannelRequestPartial::setBitrate(const qint32 &bitrate) {
    m_bitrate = bitrate;
    m_bitrate_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_bitrate_Set() const{
    return m_bitrate_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_bitrate_Valid() const{
    return m_bitrate_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getUserLimit() const {
    return m_user_limit;
}
void OAIUpdateGuildChannelRequestPartial::setUserLimit(const qint32 &user_limit) {
    m_user_limit = user_limit;
    m_user_limit_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_user_limit_Set() const{
    return m_user_limit_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_user_limit_Valid() const{
    return m_user_limit_isValid;
}

bool OAIUpdateGuildChannelRequestPartial::isNsfw() const {
    return m_nsfw;
}
void OAIUpdateGuildChannelRequestPartial::setNsfw(const bool &nsfw) {
    m_nsfw = nsfw;
    m_nsfw_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_nsfw_Set() const{
    return m_nsfw_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_nsfw_Valid() const{
    return m_nsfw_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getRateLimitPerUser() const {
    return m_rate_limit_per_user;
}
void OAIUpdateGuildChannelRequestPartial::setRateLimitPerUser(const qint32 &rate_limit_per_user) {
    m_rate_limit_per_user = rate_limit_per_user;
    m_rate_limit_per_user_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_rate_limit_per_user_Set() const{
    return m_rate_limit_per_user_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_rate_limit_per_user_Valid() const{
    return m_rate_limit_per_user_isValid;
}

QString OAIUpdateGuildChannelRequestPartial::getParentId() const {
    return m_parent_id;
}
void OAIUpdateGuildChannelRequestPartial::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QList<OAIChannelPermissionOverwriteRequest> OAIUpdateGuildChannelRequestPartial::getPermissionOverwrites() const {
    return m_permission_overwrites;
}
void OAIUpdateGuildChannelRequestPartial::setPermissionOverwrites(const QList<OAIChannelPermissionOverwriteRequest> &permission_overwrites) {
    m_permission_overwrites = permission_overwrites;
    m_permission_overwrites_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_permission_overwrites_Set() const{
    return m_permission_overwrites_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_permission_overwrites_Valid() const{
    return m_permission_overwrites_isValid;
}

QString OAIUpdateGuildChannelRequestPartial::getRtcRegion() const {
    return m_rtc_region;
}
void OAIUpdateGuildChannelRequestPartial::setRtcRegion(const QString &rtc_region) {
    m_rtc_region = rtc_region;
    m_rtc_region_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_rtc_region_Set() const{
    return m_rtc_region_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_rtc_region_Valid() const{
    return m_rtc_region_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getVideoQualityMode() const {
    return m_video_quality_mode;
}
void OAIUpdateGuildChannelRequestPartial::setVideoQualityMode(const qint32 &video_quality_mode) {
    m_video_quality_mode = video_quality_mode;
    m_video_quality_mode_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_video_quality_mode_Set() const{
    return m_video_quality_mode_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_video_quality_mode_Valid() const{
    return m_video_quality_mode_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getDefaultAutoArchiveDuration() const {
    return m_default_auto_archive_duration;
}
void OAIUpdateGuildChannelRequestPartial::setDefaultAutoArchiveDuration(const qint32 &default_auto_archive_duration) {
    m_default_auto_archive_duration = default_auto_archive_duration;
    m_default_auto_archive_duration_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_auto_archive_duration_Set() const{
    return m_default_auto_archive_duration_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_auto_archive_duration_Valid() const{
    return m_default_auto_archive_duration_isValid;
}

OAIUpdateDefaultReactionEmojiRequest OAIUpdateGuildChannelRequestPartial::getDefaultReactionEmoji() const {
    return m_default_reaction_emoji;
}
void OAIUpdateGuildChannelRequestPartial::setDefaultReactionEmoji(const OAIUpdateDefaultReactionEmojiRequest &default_reaction_emoji) {
    m_default_reaction_emoji = default_reaction_emoji;
    m_default_reaction_emoji_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_reaction_emoji_Set() const{
    return m_default_reaction_emoji_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_reaction_emoji_Valid() const{
    return m_default_reaction_emoji_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getDefaultThreadRateLimitPerUser() const {
    return m_default_thread_rate_limit_per_user;
}
void OAIUpdateGuildChannelRequestPartial::setDefaultThreadRateLimitPerUser(const qint32 &default_thread_rate_limit_per_user) {
    m_default_thread_rate_limit_per_user = default_thread_rate_limit_per_user;
    m_default_thread_rate_limit_per_user_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_thread_rate_limit_per_user_Set() const{
    return m_default_thread_rate_limit_per_user_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_thread_rate_limit_per_user_Valid() const{
    return m_default_thread_rate_limit_per_user_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getDefaultSortOrder() const {
    return m_default_sort_order;
}
void OAIUpdateGuildChannelRequestPartial::setDefaultSortOrder(const qint32 &default_sort_order) {
    m_default_sort_order = default_sort_order;
    m_default_sort_order_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_sort_order_Set() const{
    return m_default_sort_order_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_sort_order_Valid() const{
    return m_default_sort_order_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getDefaultForumLayout() const {
    return m_default_forum_layout;
}
void OAIUpdateGuildChannelRequestPartial::setDefaultForumLayout(const qint32 &default_forum_layout) {
    m_default_forum_layout = default_forum_layout;
    m_default_forum_layout_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_forum_layout_Set() const{
    return m_default_forum_layout_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_forum_layout_Valid() const{
    return m_default_forum_layout_isValid;
}

QString OAIUpdateGuildChannelRequestPartial::getDefaultTagSetting() const {
    return m_default_tag_setting;
}
void OAIUpdateGuildChannelRequestPartial::setDefaultTagSetting(const QString &default_tag_setting) {
    m_default_tag_setting = default_tag_setting;
    m_default_tag_setting_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_tag_setting_Set() const{
    return m_default_tag_setting_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_default_tag_setting_Valid() const{
    return m_default_tag_setting_isValid;
}

qint32 OAIUpdateGuildChannelRequestPartial::getFlags() const {
    return m_flags;
}
void OAIUpdateGuildChannelRequestPartial::setFlags(const qint32 &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_flags_Valid() const{
    return m_flags_isValid;
}

QList<OAIUpdateThreadTagRequest> OAIUpdateGuildChannelRequestPartial::getAvailableTags() const {
    return m_available_tags;
}
void OAIUpdateGuildChannelRequestPartial::setAvailableTags(const QList<OAIUpdateThreadTagRequest> &available_tags) {
    m_available_tags = available_tags;
    m_available_tags_isSet = true;
}

bool OAIUpdateGuildChannelRequestPartial::is_available_tags_Set() const{
    return m_available_tags_isSet;
}

bool OAIUpdateGuildChannelRequestPartial::is_available_tags_Valid() const{
    return m_available_tags_isValid;
}

bool OAIUpdateGuildChannelRequestPartial::isSet() const {
...
bool OAIUpdateGuildChannelRequestPartial::isValid() const {
