...
#ifndef OAIGet_channel_200_response_H
#define OAIGet_channel_200_response_H
...
class OAIGet_channel_200_response : public OAIObject {
public:
    OAIGet_channel_200_response();
    OAIGet_channel_200_response(QString json);
    ~OAIGet_channel_200_response() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIGet_channel_200_response)

#endif // OAIGet_channel_200_response_H
