...
#ifndef OAIUpdate_voice_state_request_H
#define OAIUpdate_voice_state_request_H
...
class OAIUpdate_voice_state_request : public OAIObject {
public:
    OAIUpdate_voice_state_request();
    OAIUpdate_voice_state_request(QString json);
    ~OAIUpdate_voice_state_request() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIUpdate_voice_state_request)

#endif // OAIUpdate_voice_state_request_H
