...
#ifndef OAIDefaultKeywordListUpsertRequest_H
#define OAIDefaultKeywordListUpsertRequest_H
...
class OAIDefaultKeywordListUpsertRequest : public OAIObject {
public:
    OAIDefaultKeywordListUpsertRequest();
    OAIDefaultKeywordListUpsertRequest(QString json);
    ~OAIDefaultKeywordListUpsertRequest() override;
...
Q_DECLARE_METATYPE(dc_rest::OAIDefaultKeywordListUpsertRequest)

#endif // OAIDefaultKeywordListUpsertRequest_H
