...
OAIPrivateGuildMemberResponse::OAIPrivateGuildMemberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrivateGuildMemberResponse::OAIPrivateGuildMemberResponse() {
    this->initializeModel();
}

OAIPrivateGuildMemberResponse::~OAIPrivateGuildMemberResponse() {}

void OAIPrivateGuildMemberResponse::initializeModel() {
...
void OAIPrivateGuildMemberResponse::fromJson(QString jsonString) {
...
void OAIPrivateGuildMemberResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPrivateGuildMemberResponse::asJson() const {
...
QJsonObject OAIPrivateGuildMemberResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_flags_isSet) {
...
qint32 OAIPrivateGuildMemberResponse::getFlags() const {
    return m_flags;
}
void OAIPrivateGuildMemberResponse::setFlags(const qint32 &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIPrivateGuildMemberResponse::is_flags_Valid() const{
    return m_flags_isValid;
}

QDateTime OAIPrivateGuildMemberResponse::getJoinedAt() const {
    return m_joined_at;
}
void OAIPrivateGuildMemberResponse::setJoinedAt(const QDateTime &joined_at) {
    m_joined_at = joined_at;
    m_joined_at_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_joined_at_Set() const{
    return m_joined_at_isSet;
}

bool OAIPrivateGuildMemberResponse::is_joined_at_Valid() const{
    return m_joined_at_isValid;
}

bool OAIPrivateGuildMemberResponse::isPending() const {
    return m_pending;
}
void OAIPrivateGuildMemberResponse::setPending(const bool &pending) {
    m_pending = pending;
    m_pending_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_pending_Set() const{
    return m_pending_isSet;
}

bool OAIPrivateGuildMemberResponse::is_pending_Valid() const{
    return m_pending_isValid;
}

QSet<QString> OAIPrivateGuildMemberResponse::getRoles() const {
    return m_roles;
}
void OAIPrivateGuildMemberResponse::setRoles(const QSet<QString> &roles) {
    m_roles = roles;
    m_roles_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_roles_Set() const{
    return m_roles_isSet;
}

bool OAIPrivateGuildMemberResponse::is_roles_Valid() const{
    return m_roles_isValid;
}

OAIUserResponse OAIPrivateGuildMemberResponse::getUser() const {
    return m_user;
}
void OAIPrivateGuildMemberResponse::setUser(const OAIUserResponse &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIPrivateGuildMemberResponse::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIPrivateGuildMemberResponse::isMute() const {
    return m_mute;
}
void OAIPrivateGuildMemberResponse::setMute(const bool &mute) {
    m_mute = mute;
    m_mute_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_mute_Set() const{
    return m_mute_isSet;
}

bool OAIPrivateGuildMemberResponse::is_mute_Valid() const{
    return m_mute_isValid;
}

bool OAIPrivateGuildMemberResponse::isDeaf() const {
    return m_deaf;
}
void OAIPrivateGuildMemberResponse::setDeaf(const bool &deaf) {
    m_deaf = deaf;
    m_deaf_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_deaf_Set() const{
    return m_deaf_isSet;
}

bool OAIPrivateGuildMemberResponse::is_deaf_Valid() const{
    return m_deaf_isValid;
}

QString OAIPrivateGuildMemberResponse::getAvatar() const {
    return m_avatar;
}
void OAIPrivateGuildMemberResponse::setAvatar(const QString &avatar) {
    m_avatar = avatar;
    m_avatar_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_avatar_Set() const{
    return m_avatar_isSet;
}

bool OAIPrivateGuildMemberResponse::is_avatar_Valid() const{
    return m_avatar_isValid;
}

OAIUserAvatarDecorationResponse OAIPrivateGuildMemberResponse::getAvatarDecorationData() const {
    return m_avatar_decoration_data;
}
void OAIPrivateGuildMemberResponse::setAvatarDecorationData(const OAIUserAvatarDecorationResponse &avatar_decoration_data) {
    m_avatar_decoration_data = avatar_decoration_data;
    m_avatar_decoration_data_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_avatar_decoration_data_Set() const{
    return m_avatar_decoration_data_isSet;
}

bool OAIPrivateGuildMemberResponse::is_avatar_decoration_data_Valid() const{
    return m_avatar_decoration_data_isValid;
}

QString OAIPrivateGuildMemberResponse::getBanner() const {
    return m_banner;
}
void OAIPrivateGuildMemberResponse::setBanner(const QString &banner) {
    m_banner = banner;
    m_banner_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_banner_Set() const{
    return m_banner_isSet;
}

bool OAIPrivateGuildMemberResponse::is_banner_Valid() const{
    return m_banner_isValid;
}

QDateTime OAIPrivateGuildMemberResponse::getCommunicationDisabledUntil() const {
    return m_communication_disabled_until;
}
void OAIPrivateGuildMemberResponse::setCommunicationDisabledUntil(const QDateTime &communication_disabled_until) {
    m_communication_disabled_until = communication_disabled_until;
    m_communication_disabled_until_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_communication_disabled_until_Set() const{
    return m_communication_disabled_until_isSet;
}

bool OAIPrivateGuildMemberResponse::is_communication_disabled_until_Valid() const{
    return m_communication_disabled_until_isValid;
}

QString OAIPrivateGuildMemberResponse::getNick() const {
    return m_nick;
}
void OAIPrivateGuildMemberResponse::setNick(const QString &nick) {
    m_nick = nick;
    m_nick_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_nick_Set() const{
    return m_nick_isSet;
}

bool OAIPrivateGuildMemberResponse::is_nick_Valid() const{
    return m_nick_isValid;
}

QDateTime OAIPrivateGuildMemberResponse::getPremiumSince() const {
    return m_premium_since;
}
void OAIPrivateGuildMemberResponse::setPremiumSince(const QDateTime &premium_since) {
    m_premium_since = premium_since;
    m_premium_since_isSet = true;
}

bool OAIPrivateGuildMemberResponse::is_premium_since_Set() const{
    return m_premium_since_isSet;
}

bool OAIPrivateGuildMemberResponse::is_premium_since_Valid() const{
    return m_premium_since_isValid;
}

bool OAIPrivateGuildMemberResponse::isSet() const {
...
bool OAIPrivateGuildMemberResponse::isValid() const {
